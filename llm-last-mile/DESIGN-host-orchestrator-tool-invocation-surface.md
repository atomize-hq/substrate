...
4. update this design doc itself only when the stable design authority changes, not just because execution surfaced a temporary drift or deferred cleanup.
