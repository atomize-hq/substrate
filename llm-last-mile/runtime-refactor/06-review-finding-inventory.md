...
| `RR-RF-0005` | `P3` | `accepted` | R4 rejected-response metadata | Rejected-response metadata still prints the older generic requirement constant while actual admission enforces the stronger protected identifier-and-CDHash requirement. | [R4 authority/security review](review-control/r3-mac-evidence-recovery-r4-review-authority-security.md); [R4 review-cycle record](review-control/r3-mac-evidence-recovery-r4-review-cycle-record.json) | It affects rejected-response diagnostic metadata only; actual XPC admission and effect paths enforce the stronger protected identity and CDHash requirement. | Future macOS response-metadata hardening; no automatic remediation authority |
| `RR-RF-0006` | `P3` | `accepted` | E3 authority-correction review | Consider a dedicated, privileged Linux inet-diag/sock-diag observation component for stronger independent cross-process listener ownership and inventory evidence; exact source at `138864a26dbc4721366c6cc8934d464d1929a189` has no such local helper. | E3 review `/root/e3_authority_review_2`; recovery disposition dated 2026-09-02 | E3 remains an unimplemented specification. Its required listener-ordering and readiness claims can be specified within the fence-named descriptor-pinned gateway authority and probe without inventing another product module or ABI. A separate observer is defense-in-depth and would expand the E3 implementation fence. | Future Linux gateway-observation hardening; requires separate admission and does not authorize E3 remediation |

The E3 authority-correction reviews produced no valid unfixed `P4` observation. This transcription
does not admit or dispatch E3 and does not authorize work on `RR-RF-0006`.
