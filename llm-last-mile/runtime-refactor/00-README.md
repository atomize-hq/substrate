...
**Current scheduling projection:** [`index/current.md`](index/current.md) is the visibly non-authoritative current-state projection for terminally complete A1.3-P1, A1.4/A1, A2, A3, Track A, E1, and E2; the completed documentation-only but specified/unadmitted E2-RM authority correction; landed E3-A through E3-D, the admitted but incomplete/unlanded E3-E implementation candidate, its landed gateway activation seam documentation, and undispatched E3-F; the separate future-admission B2.2 candidate, blocked pending `E2-RM` completion and fresh re-admission; held A1.3-P0/A1.3 records; the separate macOS lane; and deferred Windows work. Canonical decisions, packets, and gates remain at their linked path-stable owners.
...
**Non-authoritative E3 status:** E3-A through E3-D are landed. E3-E is an admitted implementation
candidate, incomplete and unlanded. Its gateway activation seam correction landed as documentation
at `d3e82fa2d486be95ab5a2326c7c8ccd304e520f6`; neither that documentation CLEAN nor the narrow
connected-recovery CLEAN completes whole-E3-E or installed acceptance. E3-F is not dispatched;
its successor requirements remain unchanged. The contracts and slice own the design:
