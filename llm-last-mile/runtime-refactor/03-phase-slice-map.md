...
A0 -> A1.1e -> B0 -> B1-3a/B1-3b receipt core -> B2.1-1/2/3 ------------------+
              \-> A1.2a current-authority protocol -> A1.2a-S bounded Start   |
                  -> B1/B2.1-R0 -> B3.2a -------------------------------------+
                                                                               -> B1/B2.1-0
                                                                               -> joint closeout
                                                                               -> B3.1 -> C1 -> A1.2b
...
The B1/B2.1 production-ingress ownership audit selects **Case B**. A1.2a must first provide the
current-authority protocol and exact read; A1.2a-S must then adopt its greenfield Start on the
...
retained truth, or broaden the two-file runtime boundary. No runtime implementation of A1.2a,
A1.2a-S, B1/B2.1-R0, B3.2a, or B1/B2.1-0 is authorized by this docs-only correction; each remains gated by its
applicable independent clean review and exact allowlist.

The A1.1d cross-packet integration hold keeps the preserved B0 → B1 receipt core → B2.1 branch
independent while A1.1e → A1.2a → A1.2a-S → B1/B2.1-R0 → B3.2a builds the
...
- Broad A1.2 transition-protocol work exposed both the missing producer-to-ledger truth path and
  ...
  restored. A1.2a is a newly bounded prerequisite packet, not permission to recover the broad WIP;
...
- The preserved B0 → B1-3a/B1-3b receipt core → B2.1-1/2/3 branch remains independent while
  A1.1e → A1.2a → A1.2a-S → B1/B2.1-R0 → B3.2a builds the authority/retained branch. They join
  ...
  preserved; the exact next implementation packet, after this docs-only sequence is independently
  review-clean, is A1.2a. B3.1 still requires the joint closeout; no
...
After all three B2.1 subpackets plus review-clean A1.2a, A1.2a-S, B1/B2.1-R0, B3.2a, and B1/B2.1-0,
...
After A1.2a, A1.2a-S, B1/B2.1-R0, and B3.2a are independently review-clean, the exact future implementation allowlist for
