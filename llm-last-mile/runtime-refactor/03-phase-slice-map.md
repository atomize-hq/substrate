...
`d0a70727c2bec2b2d6fe0754ea469c4682684dda`. B1/B2.1-0 next partitions
...
- The preserved B0 → B1-3a/B1-3b receipt core → B2.1-1/2/3 branch remains independent while
  ...
  preserved; A1.2a, A1.2a-WB, A1.2a-S, B1/B2.1-R0, B3.2a, and B3.2a-WA are independently
  review-clean. B1/B2.1-0 is next. B3.1 still requires the joint
