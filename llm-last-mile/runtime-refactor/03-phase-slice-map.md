...
B3.2a remains incomplete, and B3.2a plus B1/B2.1-0 remain gated by their applicable
...
- The preserved B0 → B1-3a/B1-3b receipt core → B2.1-1/2/3 branch remains independent while
  ...
  next implementation packet is B3.2a, which remains incomplete. B3.1 still requires the joint
