...
B3.2a must next supply the real Spawn integration plus canonical admission/routability truth that R0
...
B3.2a is next and has not begun, and B3.2a plus B1/B2.1-0 remain gated by their applicable
independent clean review and exact allowlist.
...
- The preserved B0 → B1-3a/B1-3b receipt core → B2.1-1/2/3 branch remains independent while
  ...
  preserved; A1.2a, A1.2a-WB, A1.2a-S, and B1/B2.1-R0 are independently review-clean. The exact
  next implementation packet is B3.2a, and it has not begun. B3.1 still requires the joint
