...
deliberately lacks; B3.2a-WA must then exact-adopt the HSA-bound world for shared-session physical
ownership without changing that binding; B1/B2.1-0 then partitions
...
B3.2a remains incomplete through B3.2a-WA, and B3.2a-WA plus B1/B2.1-0 remain gated by their applicable
...
- The preserved B0 → B1-3a/B1-3b receipt core → B2.1-1/2/3 branch remains independent while
  ...
  preserved; A1.2a, A1.2a-WB, A1.2a-S, and B1/B2.1-R0 are independently review-clean. B3.2a
  remains incomplete; its exact active prerequisite before closeout is B3.2a-WA. B3.1 still requires the joint
