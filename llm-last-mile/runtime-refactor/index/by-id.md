...
| `E2-RM` | prerequisite packet | [`contracts/dispatch-policy-commitment-v1.md#e2-rm--authenticated-accepted-work-receipt-material-projection-prerequisite`](../contracts/dispatch-policy-commitment-v1.md#e2-rm--authenticated-accepted-work-receipt-material-projection-prerequisite) | `E2-owned accepted-work receipt-material projection implemented/review-clean/landed; separate canonical terminal closure not located` |
