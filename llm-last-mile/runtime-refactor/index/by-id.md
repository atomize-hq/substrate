...
| `E2-RM` | prerequisite packet | [`contracts/dispatch-policy-commitment-v1.md#e2-rm--authenticated-accepted-work-receipt-material-projection-prerequisite`](../contracts/dispatch-policy-commitment-v1.md#e2-rm--authenticated-accepted-work-receipt-material-projection-prerequisite) | `E2-owned non-reconciling E2+B1 snapshot, opaque durable B1 authentication, and equality-only accepted-work receipt-material projection implemented/review-clean/landed; separate canonical terminal closure not located` |
...
| `ReadOnlyAuthoritySnapshotErrorV1` | [`contracts/dispatch-policy-commitment-v1.md#non-reconciling-physical-snapshot-contract`](../contracts/dispatch-policy-commitment-v1.md#non-reconciling-physical-snapshot-contract) | `specified fail-closed physical-read error taxonomy for E2-RM` |
| `ReadOnlyVersionedAuthorityTransactionV1` | [`contracts/dispatch-policy-commitment-v1.md#non-reconciling-physical-snapshot-contract`](../contracts/dispatch-policy-commitment-v1.md#non-reconciling-physical-snapshot-contract) | `specified existing-layout root-lock transaction with no mutation or reconciliation authority` |
| `DispatchPolicyCommitmentReadCapabilityV1` | [`contracts/dispatch-policy-commitment-v1.md#physical-e2-and-b1-capability-rules`](../contracts/dispatch-policy-commitment-v1.md#physical-e2-and-b1-capability-rules) | `specified E2 physical read capability bound to the non-reconciling transaction` |
| `DispatchPolicyCommitmentPhysicalReadV1` | [`contracts/dispatch-policy-commitment-v1.md#physical-e2-and-b1-capability-rules`](../contracts/dispatch-policy-commitment-v1.md#physical-e2-and-b1-capability-rules) | `specified clean E2 absence or immutable physical snapshot result` |
| `DispatchPolicyCommitmentPhysicalSnapshotV1` | [`contracts/dispatch-policy-commitment-v1.md#physical-e2-and-b1-capability-rules`](../contracts/dispatch-policy-commitment-v1.md#physical-e2-and-b1-capability-rules) | `specified exact stable E2 registry and key bytes` |
| `WorldWorkReceiptRegistryPhysicalReadV1` | [`contracts/dispatch-policy-commitment-v1.md#physical-e2-and-b1-capability-rules`](../contracts/dispatch-policy-commitment-v1.md#physical-e2-and-b1-capability-rules) | `specified clean B1 absence or immutable registry snapshot result` |
| `WorldWorkReceiptRegistryPhysicalSnapshotV1` | [`contracts/dispatch-policy-commitment-v1.md#physical-e2-and-b1-capability-rules`](../contracts/dispatch-policy-commitment-v1.md#physical-e2-and-b1-capability-rules) | `specified exact stable B1 registry bytes` |
| `AcceptedWorkAuthorityPhysicalSnapshotV1` | [`contracts/dispatch-policy-commitment-v1.md#physical-e2-and-b1-capability-rules`](../contracts/dispatch-policy-commitment-v1.md#physical-e2-and-b1-capability-rules) | `specified aggregate root/store/state-root-bytes/root-revision/E2/B1 snapshot captured under one existing root lock` |
| `WorldWorkAcceptanceLookupKeyV1` | [`contracts/dispatch-policy-commitment-v1.md#authenticated-b1-provenance`](../contracts/dispatch-policy-commitment-v1.md#authenticated-b1-provenance) | `specified exact authority-store and acceptance-record lookup key` |
| `AuthenticatedWorldWorkAcceptanceV1` | [`contracts/dispatch-policy-commitment-v1.md#authenticated-b1-provenance`](../contracts/dispatch-policy-commitment-v1.md#authenticated-b1-provenance) | `specified sole-success opaque complete durable B1 witness with private physical provenance` |
| `WorldWorkAcceptanceAuthenticationErrorV1` | [`contracts/dispatch-policy-commitment-v1.md#authenticated-b1-provenance`](../contracts/dispatch-policy-commitment-v1.md#authenticated-b1-provenance) | `specified B1 absence/ambiguity/encoding/schema/corruption/store error taxonomy` |
...
| `AcceptedWorkReceiptMaterialErrorV1` | [`contracts/dispatch-policy-commitment-v1.md#e2-rm--authenticated-accepted-work-receipt-material-projection-prerequisite`](../contracts/dispatch-policy-commitment-v1.md#e2-rm--authenticated-accepted-work-receipt-material-projection-prerequisite) | `specified physical/B1/E2/linkage authentication error boundary` |
| `E2SchemaObjectV1` | [`contracts/dispatch-policy-commitment-v1.md#e2-rm--authenticated-accepted-work-receipt-material-projection-prerequisite`](../contracts/dispatch-policy-commitment-v1.md#e2-rm--authenticated-accepted-work-receipt-material-projection-prerequisite) | `specified object discriminator for honest unsupported E2 version reporting` |
| `AcceptedWorkBindingFieldV1` | [`contracts/dispatch-policy-commitment-v1.md#e2-rm--authenticated-accepted-work-receipt-material-projection-prerequisite`](../contracts/dispatch-policy-commitment-v1.md#e2-rm--authenticated-accepted-work-receipt-material-projection-prerequisite) | `specified exhaustive expected-B1 and exact cross-store binding mismatch discriminator` |
...
| `e3-agent-config-projection-and-gateway-adoption` | [`slices/e3-agent-config-projection-and-gateway-adoption.md`](../slices/e3-agent-config-projection-and-gateway-adoption.md) | canonical controlling specification; E3-A–D landed; E3-E terminally complete/product landed; enclosing E3 incomplete; E3-F unadmitted/undispatched |
| `agent-config-projection-v1` | [`contracts/agent-config-projection-v1.md`](../contracts/agent-config-projection-v1.md) | canonical E3 contract specification; E3-A–D landed; E3-E terminally complete/product landed; enclosing E3 incomplete; E3-F unadmitted/undispatched |
| `managed-gateway-adoption-v1` | [`contracts/managed-gateway-adoption-v1.md`](../contracts/managed-gateway-adoption-v1.md) | canonical E3 contract specification; E3-A–D landed; E3-E terminally complete/product landed; enclosing E3 incomplete; E3-F unadmitted/undispatched |
