...
| `E2-RM` | prerequisite packet | [`contracts/dispatch-policy-commitment-v1.md#e2-rm--authenticated-accepted-work-receipt-material-projection-prerequisite`](../contracts/dispatch-policy-commitment-v1.md#e2-rm--authenticated-accepted-work-receipt-material-projection-prerequisite) | `specified, unadmitted, undispatched, and unimplemented non-reconciling E2+B1 snapshot and accepted-work receipt-material projection required before fresh B2.2 admission` |
...
| `AcceptedWorkAuthorityPhysicalSnapshotV1` | [`contracts/dispatch-policy-commitment-v1.md#physical-e2-and-b1-capability-rules`](../contracts/dispatch-policy-commitment-v1.md#physical-e2-and-b1-capability-rules) | `specified aggregate root/store/revision/E2/B1 snapshot captured under one existing root lock` |
...
| `AuthenticatedWorldWorkAcceptanceResolutionV1` | [`contracts/dispatch-policy-commitment-v1.md#authenticated-b1-provenance`](../contracts/dispatch-policy-commitment-v1.md#authenticated-b1-provenance) | `specified missing-or-authenticated B1 lookup result` |
| `AuthenticatedWorldWorkAcceptanceV1` | [`contracts/dispatch-policy-commitment-v1.md#authenticated-b1-provenance`](../contracts/dispatch-policy-commitment-v1.md#authenticated-b1-provenance) | `specified opaque complete durable B1 witness with private provenance` |
| `WorldWorkAcceptanceAuthenticationErrorV1` | [`contracts/dispatch-policy-commitment-v1.md#authenticated-b1-provenance`](../contracts/dispatch-policy-commitment-v1.md#authenticated-b1-provenance) | `specified B1 encoding/schema/corruption/identity error taxonomy` |
...
| `AcceptedWorkBindingFieldV1` | [`contracts/dispatch-policy-commitment-v1.md#e2-rm--authenticated-accepted-work-receipt-material-projection-prerequisite`](../contracts/dispatch-policy-commitment-v1.md#e2-rm--authenticated-accepted-work-receipt-material-projection-prerequisite) | `specified exact cross-store binding mismatch discriminator` |
