...
use super::freeze_manifest::{
    ...
    CandidateFreezeManifestV2, CandidateFreezeRawAbsenceObservationV2,
    CANDIDATE_FREEZE_ARTIFACT_ROOT_V2, CANDIDATE_FREEZE_ATOMIZE_SUPPORT_ROOT_V2,
...
impl RootInstallLiveAbsenceObservationV2 {
    fn validate(
        ...
        self.raw_observation.validate(expected)?;
        match (
...
impl RootInstallCompletionV2 {
    pub fn validate(
        ...
        self.launchd_label_absence.validate(launchd)?;
        self.endpoint_absence.validate(endpoint)?;
        Ok(())
    }
}
