...
pub const DISPOSABLE_FINALIZER_SCOPE_1: &str = "01a00d02-e6eb-7aaf-8e25-2df6110be194";
pub const DISPOSABLE_FINALIZER_SCOPE_2: &str = "01a00d02-e6ec-7c23-88c6-e041eee2c9b9";
