...
- [ ] Obtain fresh independent review for this R7-4 checkpoint-doc receipt. Until it is fresh-review-
  clean, keep R7-4 as the sole active phase with packet `none`, keep its exit gate and `CTX-R7-05`
  blocked/pending, keep `R7-5.1` unstarted and `R7-5..R7-6` plus R8 blocked, and do not prepare or
  invoke next-phase selectors.
