...
echo "   export SHIM_TRACE_LOG=\"\$HOME/.trace_shell.jsonl\""
echo ""
echo "🧪 Test the installation:"
echo "   PATH=\"$SHIM_DIR:\$SHIM_ORIGINAL_PATH\" bash -lc 'hash -r; which -a git; type -a git; git --version'"
echo ""
