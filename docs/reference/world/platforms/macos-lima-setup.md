...
| Agent binary missing | Service fails to start | Rebuild and copy the binary using the steps in [Breakglass: manual guest bootstrap](#breakglass-manual-guest-bootstrap). |
