...
For cross-platform Planning Packs (`tasks.json` meta: `cross_platform: true`), the integration structure depends on schema version (see also `docs/project_management/standards/PLATFORM_INTEGRATION_AND_CI.md`):
