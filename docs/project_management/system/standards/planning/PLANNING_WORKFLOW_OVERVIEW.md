...
- Cross-platform smoke via `docs/project_management/system/standards/ci/PLATFORM_INTEGRATION_AND_CI.md`
...
flowchart TD
  ...
  B["ADR authoring agent reads: docs/project_management/system/standards/adr/ADR_STANDARD_AND_TEMPLATE.md"]
  C[ADR draft created]
  SM["Spec determination agent reads: docs/project_management/system/standards/planning/PLANNING_SPEC_DETERMINATION_STANDARD.md"]
  SMD[spec_manifest.md created]
  IM["Impact map agent reads: docs/project_management/system/standards/planning/PLANNING_IMPACT_MAP_STANDARD.md"]
  IMD[impact_map.md created]
  CP["CI checkpoint planning agent reads: docs/project_management/system/standards/ci/PLANNING_CI_CHECKPOINT_STANDARD.md"]
  CPD[ci_checkpoint_plan.md created]
  D{ADR accepted}
  D_NO[ADR not accepted]
  D_YES[ADR accepted]

  P["Planning agent reads: docs/project_management/system/standards/planning/PLANNING_README.md"]
  PACK[Planning Pack created under docs/project_management/packs/active/**FEATURE_NAME**/]
  ...
  LINT["Run mechanical checks: docs/project_management/system/standards/planning/PLANNING_LINT_CHECKLIST.md"]
  REPORT["Write: docs/project_management/packs/active/<feature>/quality_gate_report.md using docs/project_management/system/templates/planning_pack/PLANNING_GATE_REPORT_TEMPLATE.md"]
  ...
  GATE_YES["Execution triads start: docs/project_management/system/standards/triad/TASK_TRIADS_AND_FEATURE_SETUP.md"]
