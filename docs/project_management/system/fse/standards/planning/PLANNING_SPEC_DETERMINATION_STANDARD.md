...
- drafting an ADR, and
- running the Planning Pack generation workflow in `docs/project_management/system/standards/planning/PLANNING_README.md`.
...
1) Draft ADR (using `docs/project_management/system/standards/adr/ADR_STANDARD_AND_TEMPLATE.md`).
...
7) Run `docs/project_management/system/standards/planning/PLANNING_README.md` to produce the remaining Planning Pack artifacts.
...
Scaffolding:
- `make planning-new-feature FEATURE=<feature>` creates `spec_manifest.md` from `docs/project_management/system/fse/templates/planning_pack/spec_manifest.md.tmpl`.
...
Standard: `docs/project_management/system/standards/shared/CONTRACT_SURFACE_STANDARD.md`
...
1) **Wire/API protocol surface**
   ...
   - Template: `docs/project_management/system/templates/spec/protocol-spec.md.tmpl`
...
2) **Data schema / file format surface**
   ...
   - Template: `docs/project_management/system/templates/spec/schema-spec.md.tmpl`
...
3) **Environment variables**
   ...
   - Template: `docs/project_management/system/templates/spec/env-vars-spec.md.tmpl`
...
4) **Policy surface**
   ...
   - Template: `docs/project_management/system/templates/spec/policy-spec.md.tmpl`
...
5) **Telemetry / observability surface**
   ...
   - Template: `docs/project_management/system/templates/spec/telemetry-spec.md.tmpl`
...
8) **Rollout / compatibility**
   ...
   - Template: `docs/project_management/system/templates/spec/compatibility-spec.md.tmpl`
...
Canonical prompt: docs/project_management/system/fse/prompts/planning/spec_manifest_agent.md
