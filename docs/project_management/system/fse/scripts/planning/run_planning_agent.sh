...
case "${AGENT}" in
    spec_manifest)
        ...
        PROMPT_FILE_REL="docs/project_management/system/fse/prompts/planning/spec_manifest_agent.md"
    ...
    impact_map)
        ...
        PROMPT_FILE_REL="docs/project_management/system/fse/prompts/planning/impact_map_agent.md"
    ...
    min_spec_draft)
        ...
        PROMPT_FILE_REL="docs/project_management/system/fse/prompts/planning/min_spec_draft_agent.md"
    ...
    workstream_triage)
        ...
        PROMPT_FILE_REL="docs/project_management/system/fse/prompts/planning/workstream_triage_agent.md"
    ...
    pre_planning_slice_reconcile)
        ...
        PROMPT_FILE_REL="docs/project_management/system/fse/prompts/planning/pre_planning_slice_reconcile_agent.md"
        ALLOWED_OUTPUTS_REL=(
    ...
    post_full_planning_reconcile)
        ...
        PROMPT_FILE_REL="docs/project_management/system/fse/prompts/planning/post_full_planning_reconcile_agent.md"
        ALLOWED_OUTPUTS_REL=(
            "${PRE_PLANNING_DIR_REL}/impact_map.md"
