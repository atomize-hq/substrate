...
As of August 28, 2025 `cargo tarpaulin` analysis (excluding the legacy `third_party/reedline` fork that has since been removed):
...
- **Total Codebase**: 1,604 lines (excluding the legacy vendor directory - accurate count)
