...
- `docs/project_management/_archived/policy-patch-only-broker-effective-resolution/C0-spec.md`: implement broker canonical effective resolution and CLI delegation.
...
- `docs/project_management/_archived/policy-patch-only-broker-effective-resolution/C1-spec.md`: implement fail-closed behavior across broker-dependent execution paths and align operator docs.
