...
1. Verify you are in the task worktree `wt/world-fs-granular-allow-deny-appendix-wfgadax3-code` on branch `world-fs-granular-allow-deny-appendix-wfgadax3-code`.
...
2. From inside the worktree, run: `make triad-task-finish TASK_ID="WFGADAX3-code"` (runs `triad-code-checks`).
