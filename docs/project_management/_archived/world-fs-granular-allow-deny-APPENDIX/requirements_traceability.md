...
- Validation:
  - Smoke: `docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX/smoke/linux-smoke.sh`
...
- Tasks: `WFGADAX2-*`
- Validation:
  - Manual playbook: `docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX/manual_testing_playbook.md`
