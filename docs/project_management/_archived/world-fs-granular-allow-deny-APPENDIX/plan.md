...
- Schema: `docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX/SCHEMA.md`
- Protocol: `docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX/PROTOCOL.md`
- Env var contract: `docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX/ENV.md`
- Security invariants: `docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX/SECURITY.md`
- Requirements mapping: `docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX/requirements_traceability.md`
- Manual testing playbook: `docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX/manual_testing_playbook.md`
