...
Authoritative requirement: `docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX/contract.md` §1.3.
...
- `docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX/contract.md` §5
- `docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX/SCHEMA.md` §1.2 + §2.1
- `docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX/PROTOCOL.md` (version lockstep)
