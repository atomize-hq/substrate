...
- Appendix operator keys and “no backwards compatibility” posture:
  - `docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX/contract.md` §1 and §5
- Env var contract:
  - `docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX/ENV.md` (delete `SUBSTRATE_WORLD_REQUIRE_WORLD`; exported state is `SUBSTRATE_WORLD_FAIL_CLOSED_ROUTING`)
- Trace metadata decision (this add-on):
  - `docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX-addon-v3-alignment/decision_register.md` (DR-AXA-0004)
