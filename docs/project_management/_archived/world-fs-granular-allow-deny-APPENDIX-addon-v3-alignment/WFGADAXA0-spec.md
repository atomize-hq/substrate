...
- Output contract: `docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX/contract.md` §1.3
...
## Out of scope
- Changing the Appendix authoritative docs (`docs/project_management/_archived/world-fs-granular-allow-deny-APPENDIX/*`) unless a true ambiguity is discovered and resolved explicitly (decision register + doc update).
