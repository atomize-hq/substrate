...
- Workflow ref: `feat/policy-patch-only-broker-effective-resolution`
- Feature dir: `docs/project_management/_archived/world-agent-policy-snapshot`
...
- Smoke run ids:
    ...
    - windows: (not emitted; job failed before running the smoke script: missing `docs/project_management/_archived/world-agent-policy-snapshot/smoke/windows-smoke.ps1`)
- Final: **FAIL** (`conclusion=failure`)
