...
- Implementation and validation ownership lives in `docs/project_management/_archived/world-first-repl-persistent-pty/requirements_traceability.md`.
...
### Decision
- Selected: Option B.
  - Authoritative spec: `docs/project_management/_archived/world-first-repl-persistent-pty/PROTOCOL.md` (“Output ordering / drain guarantee”, watermark barrier).
