...
2. Read: `docs/project_management/_archived/world-first-repl-persistent-pty/C2-spec.md`, `docs/project_management/_archived/world-first-repl-persistent-pty/PROTOCOL.md`, `docs/project_management/_archived/world-first-repl-persistent-pty/requirements_traceability.md`, this prompt.
