...
## Requirements
- Dispatch CI parity gates as listed in `docs/project_management/_archived/world-first-repl-persistent-pty/tasks.json`.
- Record run URLs and outcomes in `docs/project_management/_archived/world-first-repl-persistent-pty/session_log.md` on the orchestration branch.
