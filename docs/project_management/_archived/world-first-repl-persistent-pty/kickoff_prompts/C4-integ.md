...
2. Read: `docs/project_management/_archived/world-first-repl-persistent-pty/tasks.json`, `docs/project_management/_archived/world-first-repl-persistent-pty/C4-spec.md`, this prompt.

## Requirements
- Merge platform-fix branches and reconcile to the spec.
- Run all required checks listed in `docs/project_management/_archived/world-first-repl-persistent-pty/tasks.json` for `C4-integ`.
