Grounding (what exists today)
  ...
  - The authoritative requirement is in docs/project_management/_archived/world-first-repl-persistent-pty/PROTOCOL.md:
  ...
  - The repo already sketches the correct shape in docs/project_management/_archived/world-first-repl-persistent-pty/driver_loop_design.md: make a
