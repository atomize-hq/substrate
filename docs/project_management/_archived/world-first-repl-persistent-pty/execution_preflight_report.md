...
Expected from `docs/project_management/_archived/world-first-repl-persistent-pty/tasks.json` meta:
...
Smoke scripts:
- Linux: `docs/project_management/_archived/world-first-repl-persistent-pty/smoke/linux-smoke.sh`
- macOS: `docs/project_management/_archived/world-first-repl-persistent-pty/smoke/macos-smoke.sh`
- Windows: `docs/project_management/_archived/world-first-repl-persistent-pty/smoke/windows-smoke.ps1`
...
- `make -n feature-smoke FEATURE_DIR="docs/project_management/_archived/world-first-repl-persistent-pty" PLATFORM=behavior SMOKE_SLICE_ID="C0" RUNNER_KIND=self-hosted WORKFLOW_REF="feat/world-first-repl-persistent-pty" REMOTE=origin CLEANUP=1 RUN_INTEG_CHECKS=1` → `PASS` (exit `0`)
