...
- Linux smoke: `docs/project_management/_archived/env_var_taxonomy_and_override_split/smoke/linux-smoke.sh`
- macOS smoke: `docs/project_management/_archived/env_var_taxonomy_and_override_split/smoke/macos-smoke.sh`
- Windows smoke: `docs/project_management/_archived/env_var_taxonomy_and_override_split/smoke/windows-smoke.ps1`
