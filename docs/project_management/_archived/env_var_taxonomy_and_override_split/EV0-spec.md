...
- Feature-local smoke scripts validate the override split on all required platforms:
  - Linux: `docs/project_management/_archived/env_var_taxonomy_and_override_split/smoke/linux-smoke.sh`
  - macOS: `docs/project_management/_archived/env_var_taxonomy_and_override_split/smoke/macos-smoke.sh`
  - Windows: `docs/project_management/_archived/env_var_taxonomy_and_override_split/smoke/windows-smoke.ps1`
