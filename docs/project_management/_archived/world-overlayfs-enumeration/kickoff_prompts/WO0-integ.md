...
- Closeout gate report: `docs/project_management/_archived/world-overlayfs-enumeration/WO0-closeout_report.md`
...
3. If `.taskmeta.json` is missing or mismatched, stop and ask the operator to run:
   - `make triad-task-start FEATURE_DIR="docs/project_management/_archived/world-overlayfs-enumeration" TASK_ID="WO0-integ"`
...
## Requirements
- Run the manual playbook: `docs/project_management/_archived/world-overlayfs-enumeration/manual_testing_playbook.md`.
- Fill the closeout report: `docs/project_management/_archived/world-overlayfs-enumeration/WO0-closeout_report.md`.
