# Task I8-integ (I1 noise reduction) – INTEGRATION
...
3. Set `I8-integ` to `in_progress`, append START entry to `session_log.md`, commit docs (`docs: start I8-integ`).
4. Create branch/worktree:
   ```
   git checkout -b ahih-i8-i1-noise-integ
   git worktree add wt/ahih-i8-i1-noise-integ ahih-i8-i1-noise-integ
   cd wt/ahih-i8-i1-noise-integ
   ```
5. Do not edit docs/tasks/session_log.md inside the worktree.

## Duties
- Merge `ahih-i8-i1-noise-code` and `ahih-i8-i1-noise-test`.
- Reconcile any drift so behavior matches `I8-spec.md`.
...
4. Update `tasks.json` + `session_log.md` (END entry) and commit docs (`docs: finish I8-integ`).
5. Remove worktree.
