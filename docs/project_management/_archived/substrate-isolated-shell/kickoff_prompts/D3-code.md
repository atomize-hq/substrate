...
4. **Docs/Data Map**: record the helper details and new expectations in `docs/CONFIGURATION.md`, `docs/project_management/_archived/next/substrate_isolated_shell_data_map.md`, and any relevant README/script comments.
...
- Start by marking D3-code `in_progress` in `docs/project_management/_archived/next/tasks.json`, adding a START entry to `docs/project_management/_archived/next/session_log.md` referencing this prompt.
