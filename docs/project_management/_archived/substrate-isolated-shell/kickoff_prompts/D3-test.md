...
- Check documentation updates (`docs/CONFIGURATION.md`, `docs/project_management/_archived/next/substrate_isolated_shell_data_map.md`, D3 sections of the plan/session log) covering the helper guidance so contributors know to rely on `substrate_shell_driver` instead of invoking `target/debug/substrate` directly.
...
- Docs: `docs/CONFIGURATION.md`, `docs/project_management/_archived/next/substrate_isolated_shell_data_map.md`, plus any README/snippet referencing world toggles.
...
## Reminders
- Work inside `wt/d3-world-audit-test`, mark D3-test as `in_progress` in `docs/project_management/_archived/next/tasks.json`, and log START/END entries referencing this prompt in `docs/project_management/_archived/next/session_log.md`.
