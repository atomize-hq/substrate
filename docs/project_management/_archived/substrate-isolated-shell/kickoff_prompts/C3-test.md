...
- Reference docs: `docs/INSTALLATION.md`, `docs/UNINSTALL.md`, `docs/CONFIGURATION.md`, and Workstream C3 in `docs/project_management/_archived/next/substrate_isolated_shell_plan.md` + `subdata_map.md` for expected artifacts.
...
Reminders:
- Work inside `wt/c3-installer-test`; set C3-test to `in_progress` in `docs/project_management/_archived/next/tasks.json` and log START/END entries before/after coding.
