...
Reminders:
- Work in `wt/c3-installer-code`; update `docs/project_management/_archived/next/tasks.json` (set C3-code to `in_progress`) and add START/END entries to `docs/project_management/_archived/next/session_log.md` before/after coding.
