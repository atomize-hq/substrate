...
Expected from `docs/project_management/_archived/world_deps_selection_layer/tasks.json` meta:
...
Smoke scripts:
- Linux: `docs/project_management/_archived/world_deps_selection_layer/smoke/linux-smoke.sh`
- macOS: `docs/project_management/_archived/world_deps_selection_layer/smoke/macos-smoke.sh`
- Windows: `docs/project_management/_archived/world_deps_selection_layer/smoke/windows-smoke.ps1`
...
- `make -n feature-smoke FEATURE_DIR="docs/project_management/_archived/world_deps_selection_layer" PLATFORM=behavior RUNNER_KIND=self-hosted WORKFLOW_REF="feat/world_deps_selection_layer" REMOTE=origin CLEANUP=1 RUN_INTEG_CHECKS=1` → exit `0`
