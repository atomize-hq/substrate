...
- Add and maintain feature-local smoke scripts (no repo-root `scripts/` changes required for this triad):
  - Linux: `bash docs/project_management/_archived/world_deps_selection_layer/smoke/linux-smoke.sh`
  - macOS: `bash docs/project_management/_archived/world_deps_selection_layer/smoke/macos-smoke.sh`
  - Windows: `pwsh -File docs/project_management/_archived/world_deps_selection_layer/smoke/windows-smoke.ps1`
