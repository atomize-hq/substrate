...
- Add automatable smoke coverage via feature-local smoke scripts under `docs/project_management/_archived/world_deps_selection_layer/smoke/`.
...
- Manual playbook: `docs/project_management/_archived/world_deps_selection_layer/manual_testing_playbook.md`
