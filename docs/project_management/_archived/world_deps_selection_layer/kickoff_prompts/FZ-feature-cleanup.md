...
- `make triad-feature-cleanup FEATURE_DIR="docs/project_management/_archived/world_deps_selection_layer" DRY_RUN=1 REMOVE_WORKTREES=1 PRUNE_LOCAL=1`

Real run:
- `make triad-feature-cleanup FEATURE_DIR="docs/project_management/_archived/world_deps_selection_layer" REMOVE_WORKTREES=1 PRUNE_LOCAL=1`

Remote branch pruning (destructive; do not run unless explicitly required by the operator):
- `make triad-feature-cleanup FEATURE_DIR="docs/project_management/_archived/world_deps_selection_layer" PRUNE_REMOTE=origin PRUNE_LOCAL=1 REMOVE_WORKTREES=1`
...
## Output requirements
- Paste the script stdout summary block into the END entry for this task in `docs/project_management/_archived/world_deps_selection_layer/session_log.md`.
