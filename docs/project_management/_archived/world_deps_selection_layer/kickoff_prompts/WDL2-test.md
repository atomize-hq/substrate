...
3. If `.taskmeta.json` is missing or mismatched, stop and ask the operator to run:
   - `make triad-task-start-pair FEATURE_DIR="docs/project_management/_archived/world_deps_selection_layer" SLICE_ID="WDL2"` (preferred)
   - `make triad-task-start FEATURE_DIR="docs/project_management/_archived/world_deps_selection_layer" TASK_ID="WDL2-test"` (single task)
