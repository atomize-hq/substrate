...
## Metadata
- Feature directory: `docs/project_management/_archived/world_deps_selection_layer/`
...
```bash
export FEATURE_DIR="docs/project_management/_archived/world_deps_selection_layer"
...
p=Path("docs/project_management/_archived/world_deps_selection_layer/decision_register.md")
...
- Result: `PASS`
- Evidence: `docs/project_management/_archived/world_deps_selection_layer/S0-spec-selection-config-and-ux.md` (explicit selection gating, precedence, JSON fields, and exit codes); lint hard-ban/ambiguity scans passed.
...
- Result: `PASS`
- Evidence: `docs/project_management/_archived/world_deps_selection_layer/decision_register.md` (all DR entries have exactly two options and a single selected option; additional structural check passed).
...
- Result: `PASS`
- Evidence:
  - `docs/project_management/_archived/world_deps_selection_layer/manual_testing_playbook.md` includes runnable commands and expected exit codes/output substrings.
  - `docs/project_management/_archived/world_deps_selection_layer/smoke/linux-smoke.sh`, `docs/project_management/_archived/world_deps_selection_layer/smoke/macos-smoke.sh`, `docs/project_management/_archived/world_deps_selection_layer/smoke/windows-smoke.ps1` exist and are referenced by the playbook and tasks.
...
- Result: `PASS`
- Evidence: `docs/project_management/_archived/world_deps_selection_layer/tasks.json:2-13` (`meta.schema_version=3`, required platform sets); tasks include `WDLx-integ-core`, `WDLx-integ-linux|macos|windows`, and `WDLx-integ` per slice with correct deps.
...
- Status: `VERIFIED`
- Evidence: `make planning-lint FEATURE_DIR="docs/project_management/_archived/world_deps_selection_layer"` output includes `OK: planning lint passed` (exit `0`).
