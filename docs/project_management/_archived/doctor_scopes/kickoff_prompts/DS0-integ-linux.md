...
- Smoke script: `docs/project_management/_archived/doctor_scopes/smoke/linux-smoke.sh`
...
3. If `.taskmeta.json` is missing or mismatched, stop and ask the operator to run:
   - `make triad-task-start FEATURE_DIR="docs/project_management/_archived/doctor_scopes" TASK_ID="DS0-integ-linux"`
