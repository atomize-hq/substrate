...
3. Set `PCM0-integ` status to `in_progress` in `docs/project_management/_archived/next/policy_and_config_mental_model_simplification/tasks.json`; add a START entry to `docs/project_management/_archived/next/policy_and_config_mental_model_simplification/session_log.md`; commit docs (`docs: start PCM0-integ`).
...
5. Update `docs/project_management/_archived/next/policy_and_config_mental_model_simplification/tasks.json` + `docs/project_management/_archived/next/policy_and_config_mental_model_simplification/session_log.md` (END entry), commit docs (`docs: finish PCM0-integ`).
6. Remove worktree.
