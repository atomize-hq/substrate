...
```bash
# JSON validity
jq -e . "docs/project_management/_archived/next/policy_and_config_mental_model_simplification/tasks.json" >/dev/null
# exit 0
...
export FEATURE_DIR="docs/project_management/_archived/next/policy_and_config_mental_model_simplification"
python - <<'PY'
import json, os
...
jq -e --arg dir "$FEATURE_DIR" '.sprints[] | select(.directory==$dir) | .id' docs/project_management/packs/sequencing.json
...
- Result: `PASS`
- Evidence:
  - `docs/project_management/_archived/next/policy_and_config_mental_model_simplification/PCM2-spec.md` (cmd_allowed semantics)
  - `docs/project_management/_archived/next/policy_and_config_mental_model_simplification/PCM3-spec.md` (manager env bashenv path; world enable flags)
...
- Result: `PASS`
- Evidence: `docs/project_management/_archived/next/policy_and_config_mental_model_simplification/decision_register.md` (DR-0001..DR-0010)
...
- Result: `PASS`
- Evidence:
  - `docs/project_management/packs/sequencing.json` (sprint `policy_and_config_mental_model_simplification`, ids `PCM0..PCM3`)
  - `docs/project_management/_archived/next/policy_and_config_mental_model_simplification/tasks.json` deps:
...
- Result: `PASS`
- Evidence:
  - `docs/project_management/_archived/next/policy_and_config_mental_model_simplification/tasks.json` required fields present (see preflight)
  - Kickoff prompts include “no docs edits in worktrees”: `docs/project_management/_archived/next/policy_and_config_mental_model_simplification/kickoff_prompts/*`
...
- Status: `VERIFIED`
- Evidence:
  - `docs/project_management/_archived/next/policy_and_config_mental_model_simplification/PCM2-spec.md` now matches ADR-0003 allowlist semantics for `cmd_allowed`.
...
- Evidence:
  ...
  - `docs/project_management/_archived/next/policy_and_config_mental_model_simplification/PCM3-spec.md` matches ADR-0003:
...
- Evidence:
  ...
  - `docs/project_management/_archived/next/policy_and_config_mental_model_simplification/PCM3-spec.md` now matches the exact command and flag set.
