# Kickoff: WFGAD1-integ-windows (integration platform-fix — windows)

## Scope
- Fix Windows failures detected at checkpoint boundary for slice WFGAD1.
...
2. Verify you are in the task worktree `wt/world-fs-granular-allow-deny-wfgad1-integ-windows` on branch `world-fs-granular-allow-deny-wfgad1-integ-windows` and that `.taskmeta.json` exists at the worktree root.
...
## End Checklist
1. From inside the worktree, run: `make triad-task-finish TASK_ID="WFGAD1-integ-windows"`
