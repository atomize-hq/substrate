# Kickoff: WFGAD5-integ-linux (integration platform-fix — linux)

## Scope
- Fix Linux failures detected at checkpoint boundary for slice WFGAD5.
...
2. Verify you are in the task worktree `wt/world-fs-granular-allow-deny-wfgad5-integ-linux` on branch `world-fs-granular-allow-deny-wfgad5-integ-linux` and that `.taskmeta.json` exists at the worktree root.
...
## End Checklist
1. From inside the worktree, run: `make triad-task-finish TASK_ID="WFGAD5-integ-linux"`
