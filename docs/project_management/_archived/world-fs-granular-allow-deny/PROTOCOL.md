...
Fail-closed rules:
- World-agent MUST validate `policy_snapshot` against `docs/project_management/_archived/world-fs-granular-allow-deny/SCHEMA.md`.
...
- World-agent MUST validate `start_session.policy_snapshot` against `docs/project_management/_archived/world-fs-granular-allow-deny/SCHEMA.md`.
