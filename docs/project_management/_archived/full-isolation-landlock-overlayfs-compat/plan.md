...
- Execution triads do not begin unless:
  - `docs/project_management/_archived/full-isolation-landlock-overlayfs-compat/execution_preflight_report.md` contains `RECOMMENDATION: ACCEPT`.
  - `docs/project_management/_archived/full-isolation-landlock-overlayfs-compat/quality_gate_report.md` exists and contains `RECOMMENDATION: ACCEPT`.
