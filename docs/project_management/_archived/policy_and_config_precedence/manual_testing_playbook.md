...
- Linux: `bash docs/project_management/_archived/policy_and_config_precedence/smoke/linux-smoke.sh` → exit `0`
- macOS: `bash docs/project_management/_archived/policy_and_config_precedence/smoke/macos-smoke.sh` → exit `0`
- Windows: `pwsh -File docs/project_management/_archived/policy_and_config_precedence/smoke/windows-smoke.ps1` → exit `0`
...
```bash
FEATURE_DIR="docs/project_management/_archived/policy_and_config_precedence"
