...
- Planning Pack directory: `docs/project_management/_archived/policy_and_config_precedence/`
...
1. `make triad-orch-ensure FEATURE_DIR="docs/project_management/_archived/policy_and_config_precedence"`
