...
- Linux smoke: `docs/project_management/_archived/policy_and_config_precedence/smoke/linux-smoke.sh`
- macOS smoke: `docs/project_management/_archived/policy_and_config_precedence/smoke/macos-smoke.sh`
- Windows smoke: `docs/project_management/_archived/policy_and_config_precedence/smoke/windows-smoke.ps1`
