...
- Report: `docs/project_management/_archived/policy_and_config_precedence/execution_preflight_report.md`
...
1. Ensure the orchestration branch exists and is checked out:
   - `make triad-orch-ensure FEATURE_DIR="docs/project_management/_archived/policy_and_config_precedence"`
2. Read: ADR + Executive Summary, `docs/project_management/_archived/policy_and_config_precedence/plan.md`, `docs/project_management/_archived/policy_and_config_precedence/tasks.json`, `docs/project_management/_archived/policy_and_config_precedence/session_log.md`, `docs/project_management/_archived/policy_and_config_precedence/PCP0-spec.md`, and this prompt.
...
Fill `docs/project_management/_archived/policy_and_config_precedence/execution_preflight_report.md` with a concrete recommendation:
...
- CI dispatch commands embedded in integration tasks are runnable (for this feature: `make feature-smoke ...`).
