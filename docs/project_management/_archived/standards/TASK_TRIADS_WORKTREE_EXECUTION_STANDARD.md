...
- Updating `docs/project_management/packs/active/<feature>/tasks.json` statuses.
- Appending START/END entries to `docs/project_management/packs/active/<feature>/session_log.md`.
