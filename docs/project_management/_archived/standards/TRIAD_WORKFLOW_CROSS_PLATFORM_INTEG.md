...
flowchart TD
  ...
  subgraph START_INT["triad task_start (automation)"]
  ...
  subgraph START_PAIR_INT["triad task_start_pair (automation)"]
  ...
  subgraph START_COMPLETE_INT["triad task_start_complete (automation wrapper)"]
  ...
  subgraph START_PF_INT["triad task_start_platform_fixes (automation)"]
  ...
  subgraph START_FINAL_INT["triad task_start_integ_final (automation)"]
  ...
  subgraph FINISH_INT["triad task_finish (automation)"]
