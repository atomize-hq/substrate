...
- Report: `docs/project_management/next/full-isolation-landlock-overlayfs-compat/execution_preflight_report.md`
...
1. Ensure the orchestration branch exists and is checked out:
   - `make triad-orch-ensure FEATURE_DIR="docs/project_management/next/full-isolation-landlock-overlayfs-compat"`
2. Read: ADR + Executive Summary, `docs/project_management/next/full-isolation-landlock-overlayfs-compat/plan.md`, `docs/project_management/next/full-isolation-landlock-overlayfs-compat/tasks.json`, `docs/project_management/next/full-isolation-landlock-overlayfs-compat/session_log.md`, relevant specs, and this prompt.
...
Fill `docs/project_management/next/full-isolation-landlock-overlayfs-compat/execution_preflight_report.md` with a concrete recommendation:
