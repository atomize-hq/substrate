...
```bash
export FEATURE_DIR="docs/project_management/next/full-isolation-landlock-overlayfs-compat"
...
- `jq '.meta | {schema_version, cross_platform, behavior_platforms_required, ci_parity_platforms_required, execution_gates}' docs/project_management/next/full-isolation-landlock-overlayfs-compat/tasks.json`

## Required Inputs Read End-to-End (checklist)

- ADR(s): `YES` (`docs/project_management/next/ADR-0015-full-isolation-landlock-overlayfs-backing-dirs.md`)
- `plan.md`: `YES` (`docs/project_management/next/full-isolation-landlock-overlayfs-compat/plan.md`)
- `tasks.json`: `YES` (`docs/project_management/next/full-isolation-landlock-overlayfs-compat/tasks.json`)
- `session_log.md`: `YES` (`docs/project_management/next/full-isolation-landlock-overlayfs-compat/session_log.md`)
- All specs in scope: `YES` (`docs/project_management/next/full-isolation-landlock-overlayfs-compat/C0-spec.md`)
- `decision_register.md`: `YES` (`docs/project_management/next/full-isolation-landlock-overlayfs-compat/decision_register.md`)
- `integration_map.md`: `YES` (`docs/project_management/next/full-isolation-landlock-overlayfs-compat/integration_map.md`)
- `manual_testing_playbook.md`: `YES` (`docs/project_management/next/full-isolation-landlock-overlayfs-compat/manual_testing_playbook.md`)
- Feature smoke scripts under `smoke/`: `YES` (`docs/project_management/next/full-isolation-landlock-overlayfs-compat/smoke/*`)
...
- Result: `PASS`
- Evidence: `docs/project_management/next/full-isolation-landlock-overlayfs-compat/C0-spec.md` (Behavior + Error handling); `make planning-lint` ambiguity scan passed
...
- Result: `PASS`
- Evidence:
  - `docs/project_management/next/full-isolation-landlock-overlayfs-compat/decision_register.md` DR-0004 (fail closed vs disable Landlock for this exec)
  - `docs/project_management/next/full-isolation-landlock-overlayfs-compat/decision_register.md` DR-0005 (Linux+macOS behavior platforms vs Linux-only)
...
- Evidence:
  ...
  - `docs/project_management/next/full-isolation-landlock-overlayfs-compat/C0-spec.md` (exit code `4` for missing prerequisites)
  - `docs/project_management/next/full-isolation-landlock-overlayfs-compat/manual_testing_playbook.md` (explicit commands + expected output)
...
- Evidence:
  ...
  - `docs/project_management/next/full-isolation-landlock-overlayfs-compat/tasks.json` depends_on chain: `F0-exec-preflight → (C0-code,C0-test) → C0-integ-core → (C0-integ-{linux,macos,windows}) → C0-integ → FZ-feature-cleanup`
- Notes: Task deps are consistent with the sequencing entry for this feature.

### 5) Testability and validation readiness
- Result: `PASS`
- Evidence:
  - `docs/project_management/next/full-isolation-landlock-overlayfs-compat/manual_testing_playbook.md` (runnable commands + expected output)
...
- Result: `PASS`
- Evidence:
  - `docs/project_management/next/full-isolation-landlock-overlayfs-compat/tasks.json` meta: `schema_version=3`, `cross_platform=true`, `behavior_platforms_required=["linux","macos"]`, `ci_parity_platforms_required=["linux","macos","windows"]`
...
- Status: `VERIFIED`
- Evidence: `docs/project_management/next/full-isolation-landlock-overlayfs-compat/decision_register.md` DR-0004 (Option B is “disable Landlock for this exec and proceed with mount-only enforcement”)
...
- Status: `VERIFIED`
- Evidence:
  - `docs/project_management/next/full-isolation-landlock-overlayfs-compat/decision_register.md` DR-0005 (Selected: Linux+macOS behavior platforms)
  - `docs/project_management/next/full-isolation-landlock-overlayfs-compat/tasks.json` meta (`behavior_platforms_required=["linux","macos"]`)
  - `docs/project_management/next/full-isolation-landlock-overlayfs-compat/smoke/macos-smoke.sh` (non-no-op)
