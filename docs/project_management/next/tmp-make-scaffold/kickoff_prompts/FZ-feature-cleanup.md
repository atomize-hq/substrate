...
- `<git-common-dir>/triad/features/tmp-make-scaffold/worktrees.json`

Dry-run (recommended first):
- `make triad-feature-cleanup FEATURE_DIR="docs/project_management/next/tmp-make-scaffold" DRY_RUN=1 REMOVE_WORKTREES=1 PRUNE_LOCAL=1`

Real run:
- `make triad-feature-cleanup FEATURE_DIR="docs/project_management/next/tmp-make-scaffold" REMOVE_WORKTREES=1 PRUNE_LOCAL=1`

Remote branch pruning (optional, destructive):
- `make triad-feature-cleanup FEATURE_DIR="docs/project_management/next/tmp-make-scaffold" PRUNE_REMOTE=origin PRUNE_LOCAL=1 REMOVE_WORKTREES=1`
