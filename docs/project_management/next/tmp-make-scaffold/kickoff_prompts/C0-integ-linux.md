...
- Validate platform smoke via CI for this platform (repeat until green if you make fixes):
  - `make feature-smoke FEATURE_DIR="docs/project_management/next/tmp-make-scaffold" PLATFORM=linux RUN_WSL=1 RUNNER_KIND=self-hosted WORKFLOW_REF="feat/tmp-make-scaffold" REMOTE=origin CLEANUP=1 RUN_INTEG_CHECKS=1`
