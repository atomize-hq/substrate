...
## Scope
- Merge `M2-code` + `M2-test`, reconcile behavior to M2-spec, and gate with fmt/clippy/tests + `make integ-checks`. Integration owns final mac installer/uninstaller parity.
