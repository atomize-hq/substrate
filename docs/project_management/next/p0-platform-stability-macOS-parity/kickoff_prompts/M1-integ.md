...
## Scope
- Merge `M1-code` + `M1-test`, resolve drift against M1-spec, and ensure the socket parity replacement flow is green. Integration owns fmt/clippy/tests + `make integ-checks`.
