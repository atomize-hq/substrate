...
- `make planning-validate FEATURE_DIR="docs/project_management/next/world-fs-granular-allow-deny-APPENDIX-addon-v3-alignment"`
- `make planning-lint FEATURE_DIR="docs/project_management/next/world-fs-granular-allow-deny-APPENDIX-addon-v3-alignment"`
- `bash -n docs/project_management/next/world-fs-granular-allow-deny-APPENDIX-addon-v3-alignment/smoke/_core.sh`
- `bash -n docs/project_management/next/world-fs-granular-allow-deny-APPENDIX-addon-v3-alignment/smoke/linux-smoke.sh`
- `bash -n docs/project_management/next/world-fs-granular-allow-deny-APPENDIX-addon-v3-alignment/smoke/macos-smoke.sh`

## Inputs Reviewed

- [x] Planning quality gate is `ACCEPT` (`docs/project_management/next/world-fs-granular-allow-deny-APPENDIX-addon-v3-alignment/quality_gate_report.md`)
...
- Smoke command(s):
  - Linux: `bash docs/project_management/next/world-fs-granular-allow-deny-APPENDIX-addon-v3-alignment/smoke/linux-smoke.sh`
  - macOS: `bash docs/project_management/next/world-fs-granular-allow-deny-APPENDIX-addon-v3-alignment/smoke/macos-smoke.sh`
...
- `FEATURE_DIR="docs/project_management/next/world-fs-granular-allow-deny-APPENDIX-addon-v3-alignment"`
