...
### Create
- `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX-addon-v3-alignment/WFGADAXA1-spec.md` — snapshot V3 migration slice spec
- `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX-addon-v3-alignment/WFGADAXA2-spec.md` — downstream surface + docs alignment slice spec
- `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX-addon-v3-alignment/smoke/macos-smoke.sh` — parity smoke wrapper (macOS)
- Windows is not supported for this add-on pack; no Windows smoke script.
- (execution gates) `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX-addon-v3-alignment/WFGADAXA1-closeout_report.md`
- (execution gates) `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX-addon-v3-alignment/WFGADAXA2-closeout_report.md`
...
- Base pack: `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/`
...
- Spec updates required (if any):
  - `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX-addon-v3-alignment/spec_manifest.md` — <change>
  - <spec doc> — <change>
