...
- Snapshot schema: `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/SCHEMA.md` §2
  - `schema_version` MUST be `3`
  - unknown fields MUST be rejected by world-agent (HTTP 400 / fatal WS error frame)
- Protocol surfaces: `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/PROTOCOL.md`
