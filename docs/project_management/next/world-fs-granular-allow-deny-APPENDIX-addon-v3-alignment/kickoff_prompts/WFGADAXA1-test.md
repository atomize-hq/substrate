...
- Authoritative: `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/SCHEMA.md` (§2) and `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/PROTOCOL.md`
