...
4. If possible, run local smoke for your platform (slice-scoped):
   - Linux: `SUBSTRATE_SMOKE_SLICE_ID=WDH1 bash docs/project_management/next/world-deps-host-visible-hardening/smoke/linux-smoke.sh`
   - macOS: `SUBSTRATE_SMOKE_SLICE_ID=WDH1 bash docs/project_management/next/world-deps-host-visible-hardening/smoke/macos-smoke.sh`
