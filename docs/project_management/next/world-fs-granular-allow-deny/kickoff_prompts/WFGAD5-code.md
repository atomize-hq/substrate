...
3. If `.taskmeta.json` is missing or mismatched, stop and ask the operator to run:
   - `make triad-task-start-pair FEATURE_DIR="docs/project_management/next/world-fs-granular-allow-deny" SLICE_ID="WFGAD5"`
   - `make triad-task-start FEATURE_DIR="docs/project_management/next/world-fs-granular-allow-deny" TASK_ID="WFGAD5-code"`
