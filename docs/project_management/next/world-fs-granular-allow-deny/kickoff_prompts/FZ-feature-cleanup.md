...
Dry-run (run first):
- `make triad-feature-cleanup FEATURE_DIR="docs/project_management/next/world-fs-granular-allow-deny" DRY_RUN=1 REMOVE_WORKTREES=1 PRUNE_LOCAL=1`

Real run:
- `make triad-feature-cleanup FEATURE_DIR="docs/project_management/next/world-fs-granular-allow-deny" REMOVE_WORKTREES=1 PRUNE_LOCAL=1`

Remote branch pruning (optional, destructive):
- `make triad-feature-cleanup FEATURE_DIR="docs/project_management/next/world-fs-granular-allow-deny" PRUNE_REMOTE=origin PRUNE_LOCAL=1 REMOVE_WORKTREES=1`
...
## Output requirements
- Paste the script stdout summary block into the END entry for this task in `docs/project_management/next/world-fs-granular-allow-deny/session_log.md`.
