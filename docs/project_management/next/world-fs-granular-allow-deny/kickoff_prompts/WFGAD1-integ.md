# Kickoff: WFGAD1-integ (integration)
...
3. If `.taskmeta.json` is missing or mismatched, stop and ask the operator to run:
   - `make triad-task-start FEATURE_DIR="docs/project_management/next/world-fs-granular-allow-deny" TASK_ID="WFGAD1-integ"`
...
2. From inside the worktree, run: `make triad-task-finish TASK_ID="WFGAD1-integ"`
