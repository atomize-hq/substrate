...
1. Verify you are in the task worktree `wt/world-fs-granular-allow-deny-wfgad1-code` on branch `world-fs-granular-allow-deny-wfgad1-code` and that `.taskmeta.json` exists at the worktree root.
...
3. If `.taskmeta.json` is missing or mismatched, stop and ask the operator to run:
   - `make triad-task-start-pair FEATURE_DIR="docs/project_management/next/world-fs-granular-allow-deny" SLICE_ID="WFGAD1"`
   - `make triad-task-start FEATURE_DIR="docs/project_management/next/world-fs-granular-allow-deny" TASK_ID="WFGAD1-code"`
...
2. From inside the worktree, run: `make triad-task-finish TASK_ID="WFGAD1-code"`
