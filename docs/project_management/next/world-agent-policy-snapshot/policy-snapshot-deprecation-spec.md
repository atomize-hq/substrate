...
- `docs/project_management/next/world-agent-policy-snapshot/decision_register.md` (DR-0002, DR-0005, DR-0008, DR-0011)
...
- If the connected world-agent does not indicate PolicySnapshotV1 support:
  - the host MUST follow the fallback rules in `docs/project_management/next/world-agent-policy-snapshot/policy-snapshot-spec.md`.
