...
- `<git-common-dir>/triad/features/e2e-triad-smoke-20251231T140805Z/worktrees.json`

Dry-run (recommended first):
- `make triad-feature-cleanup FEATURE_DIR="docs/project_management/next/e2e-triad-smoke-20251231T140805Z" DRY_RUN=1 REMOVE_WORKTREES=1 PRUNE_LOCAL=1`

Real run:
- `make triad-feature-cleanup FEATURE_DIR="docs/project_management/next/e2e-triad-smoke-20251231T140805Z" REMOVE_WORKTREES=1 PRUNE_LOCAL=1`

Remote branch pruning (optional, destructive):
- `make triad-feature-cleanup FEATURE_DIR="docs/project_management/next/e2e-triad-smoke-20251231T140805Z" PRUNE_REMOTE=origin PRUNE_LOCAL=1 REMOVE_WORKTREES=1`
