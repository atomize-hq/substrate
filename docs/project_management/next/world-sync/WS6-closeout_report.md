...
- Links:
  ...
  - Internal git: `docs/project_management/next/world-sync/internal-git-spec.md`
...
- Evidence ledger path (if used): `docs/project_management/next/world-sync/logs/WS6/ci-audit/ledger.jsonl`
