...
1. Ensure the orchestration branch exists and is checked out:
   - `make triad-orch-ensure FEATURE_DIR="docs/project_management/next/world-sync"`
2. Read: ADR + Executive Summary, `docs/project_management/next/world-sync/plan.md`, `docs/project_management/next/world-sync/tasks.json`, `docs/project_management/next/world-sync/session_log.md`, relevant specs, and this prompt.
...
Fill `docs/project_management/next/world-sync/execution_preflight_report.md` with a concrete recommendation:
