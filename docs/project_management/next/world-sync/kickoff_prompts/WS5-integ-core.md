# Kickoff: WS5-integ-core (integration core)
...
1. Verify you are in the task worktree `wt/world-sync-ws5-integ-core` on branch `world-sync-ws5-integ-core` and that `.taskmeta.json` exists at the worktree root.
...
3. If `.taskmeta.json` is missing or mismatched, stop and ask the operator to run:
   - `make triad-task-start FEATURE_DIR="docs/project_management/next/world-sync" TASK_ID="WS5-integ-core"`
...
1. Ensure your merged state is committed and local integration gates are green:
   - From inside the worktree, run: `make triad-task-finish TASK_ID="WS5-integ-core"`
