...
3. If `.taskmeta.json` is missing or mismatched, stop and ask the operator to run:
   - `make triad-task-start FEATURE_DIR="docs/project_management/next/world-sync" TASK_ID="WS6-integ"`
...
- Complete the slice closeout gate report:
  - `docs/project_management/next/world-sync/WS6-closeout_report.md` (e.g., `docs/project_management/next/world-sync/WS6-closeout_report.md`)
