...
5. Update tasks.json (C7-integ status), add END entry to session_log.md (commands/results/blockers).
6. Commit docs (`docs: finish C7-integ`). Remove worktree if done.
