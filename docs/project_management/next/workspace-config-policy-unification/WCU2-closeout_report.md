...
- Links: `docs/project_management/next/workspace-config-policy-unification/WCU2-spec.md`, `docs/project_management/next/ADR-0012-config-schema-per-key-merge-and-provenance.md`, `docs/project_management/next/workspace-config-policy-unification/PHASE_A_B_GATES_ADR_0012.md`
