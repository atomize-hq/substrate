...
1) The structured agent event envelope (schema and invariants)
   - Authoritative schema: `docs/project_management/next/agent-hub-concurrent-execution-output-routing/agent-hub-event-envelope-schema-spec.md`
2) Canonical trace persistence for structured agent events
   - Authoritative record shapes: `docs/project_management/next/agent-hub-concurrent-execution-output-routing/telemetry-spec.md`
