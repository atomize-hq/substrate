...
### Create
- `docs/project_management/next/agent-hub-concurrent-execution-output-routing/spec_manifest.md` — required spec ownership map (planning v4)
- `docs/project_management/next/agent-hub-concurrent-execution-output-routing/impact_map.md` — impact map (planning v4)
- `docs/project_management/next/agent-hub-concurrent-execution-output-routing/contract.md` — operator-facing output routing + config contract
