...
- World-agent enforcement inputs remain concurrency-safe and policy-home agnostic:
  - host-resolved policy snapshot input to world-agent: `docs/project_management/next/ADR-0014-world-agent-policy-resolution-and-concurrency.md`
  - policy schema invariants (full isolation): `docs/project_management/next/ADR-0018-world-fs-granular-allow-deny-and-strict-deny.md`
