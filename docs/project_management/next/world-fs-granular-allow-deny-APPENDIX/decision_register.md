...
- `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/WFGADAX0-spec.md`
...
- Update operator-facing contract surfaces to use `host_visible`: `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/contract.md`.
...
- `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/WFGADAX1-spec.md`
...
- `docs/project_management/next/ADR-0018-world-fs-granular-allow-deny-and-strict-deny.md` (Appendix A)
- `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/SCHEMA.md`
- `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/SECURITY.md`
...
- Validate security semantics and docs alignment: `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/SECURITY.md`.
...
- `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/contract.md`
- `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/WFGADAX2-spec.md`
...
- Validate with manual playbook cases (caging required): `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/manual_testing_playbook.md`.
...
- `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/contract.md`
- `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/WFGADAX3-spec.md`
...
- Validate manual cases (exit note and `repl.exit_cwd=last_world`): `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/manual_testing_playbook.md`.
