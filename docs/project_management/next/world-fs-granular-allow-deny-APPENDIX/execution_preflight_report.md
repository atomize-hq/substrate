...
- Feature dir: `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX`
...
## Evidence
- Planning lint: `make planning-lint FEATURE_DIR="docs/project_management/next/world-fs-granular-allow-deny-APPENDIX"`
- Planning validate: `make planning-validate FEATURE_DIR="docs/project_management/next/world-fs-granular-allow-deny-APPENDIX"`

### `make planning-lint`
Command:
- `make planning-lint FEATURE_DIR="docs/project_management/next/world-fs-granular-allow-deny-APPENDIX"`

Observed output:
```text
scripts/planning/lint.sh --feature-dir "docs/project_management/next/world-fs-granular-allow-deny-APPENDIX"
== Planning lint: docs/project_management/next/world-fs-granular-allow-deny-APPENDIX ==
-- Smoke script scaffold scan
-- Hard-ban scan
-- Ambiguity scan
-- JSON validity
-- tasks.json invariants
OK: tasks.json validation passed: docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/tasks.json
...
Command:
- `make planning-validate FEATURE_DIR="docs/project_management/next/world-fs-granular-allow-deny-APPENDIX"`

Observed output:
```text
python3 scripts/planning/validate_tasks_json.py --feature-dir "docs/project_management/next/world-fs-granular-allow-deny-APPENDIX"
OK: tasks.json validation passed: docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/tasks.json
exit:0
```
...
Command:
- `bash -n docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/smoke/linux-smoke.sh`
