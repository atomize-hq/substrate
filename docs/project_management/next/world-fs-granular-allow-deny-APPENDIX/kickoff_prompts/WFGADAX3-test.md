...
1. Verify you are in the task worktree `wt/world-fs-granular-allow-deny-appendix-wfgadax3-test` on branch `world-fs-granular-allow-deny-appendix-wfgadax3-test`.
...
- `cargo test -p shell wfgadax3 -- --nocapture`

## End Checklist
1. Run the required commands above.
2. From inside the worktree, run: `make triad-task-finish TASK_ID="WFGADAX3-test"` (runs `triad-test-checks`).
