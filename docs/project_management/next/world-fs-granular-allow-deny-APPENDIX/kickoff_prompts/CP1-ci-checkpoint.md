...
- Checkpoint plan: `docs/project_management/next/world-fs-granular-allow-deny-APPENDIX/ci_checkpoint_plan.md`

## Start Checklist
Do not edit planning docs inside the worktree.

1. Confirm `WFGADAX1-integ-core` is completed.
2. Set:
   ...
   - `export SMOKE_SLICE_ID="WFGADAX1"`
