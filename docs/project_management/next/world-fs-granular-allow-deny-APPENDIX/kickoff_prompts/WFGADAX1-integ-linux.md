# Kickoff: WFGADAX1-integ-linux (integration)
...
1. Verify you are in the task worktree `wt/world-fs-granular-allow-deny-appendix-wfgadax1-integ-linux` on branch `world-fs-granular-allow-deny-appendix-wfgadax1-integ-linux`.
...
2. From inside the worktree, run: `make triad-task-finish TASK_ID="WFGADAX1-integ-linux"` (runs `integ-checks`).
