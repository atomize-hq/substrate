...
- Report: `docs/project_management/next/e2e-triad-smoke-20251231T141008Z/execution_preflight_report.md`
...
1. Ensure the orchestration branch exists and is checked out:
   - `make triad-orch-ensure FEATURE_DIR="docs/project_management/next/e2e-triad-smoke-20251231T141008Z"`
2. Read: ADR + Executive Summary, `docs/project_management/next/e2e-triad-smoke-20251231T141008Z/plan.md`, `docs/project_management/next/e2e-triad-smoke-20251231T141008Z/tasks.json`, `docs/project_management/next/e2e-triad-smoke-20251231T141008Z/session_log.md`, relevant specs, and this prompt.
...
Fill `docs/project_management/next/e2e-triad-smoke-20251231T141008Z/execution_preflight_report.md` with a concrete recommendation:
