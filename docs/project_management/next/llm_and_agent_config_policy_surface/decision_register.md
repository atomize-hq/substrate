...
**Date:** 2026-02-08  
**Status:** Accepted  
**Related docs:** `docs/project_management/adrs/draft/ADR-0027-llm-and-agent-config-policy-surface.md`, `docs/project_management/next/llm_and_agent_config_policy_surface/SCHEMA.md`
...
**Superseded by**
- `docs/project_management/next/llm_and_agent_config_policy_surface/decision_register.md` (DR-0004)
