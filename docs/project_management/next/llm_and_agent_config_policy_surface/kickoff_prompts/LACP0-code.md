...
3. If `.taskmeta.json` is missing or mismatched, stop and ask the operator to run:
   - `make triad-task-start-pair FEATURE_DIR="docs/project_management/next/llm_and_agent_config_policy_surface" SLICE_ID="LACP0"`
   - `make triad-task-start FEATURE_DIR="docs/project_management/next/llm_and_agent_config_policy_surface" TASK_ID="LACP0-code"`
