...
## End Checklist
1. Dispatch Windows smoke via CI: `scripts/ci/dispatch_feature_smoke.sh --feature-dir "docs/project_management/next/policy-patch-only-broker-effective-resolution" --runner-kind self-hosted --platform windows --workflow-ref "feat/policy-patch-only-broker-effective-resolution" --cleanup`
