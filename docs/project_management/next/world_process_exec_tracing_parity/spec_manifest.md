...
- `docs/project_management/next/world_process_exec_tracing_parity/spec_manifest.md` — spec selection + ownership map (this file)
- `docs/project_management/next/world_process_exec_tracing_parity/impact_map.md` — touch set + cascading implications + cross-queue conflicts
- `docs/project_management/next/world_process_exec_tracing_parity/plan.md` — execution runbook + sequencing overview
- `docs/project_management/next/world_process_exec_tracing_parity/tasks.json` — triad task graph + acceptance criteria
- `docs/project_management/next/world_process_exec_tracing_parity/session_log.md` — planning + execution audit log
- `docs/project_management/next/world_process_exec_tracing_parity/ci_checkpoint_plan.md` — bounded CI checkpoint plan (cross-platform automation packs)
- `docs/project_management/next/world_process_exec_tracing_parity/quality_gate_report.md` — planning quality gate outcome

- Slice specs:
  - `docs/project_management/next/world_process_exec_tracing_parity/WPEP0-spec.md` — span correctness + joinability + preexec safety
  - `docs/project_management/next/world_process_exec_tracing_parity/WPEP1-spec.md` — world-agent API + types + shell persistence for process events
  - `docs/project_management/next/world_process_exec_tracing_parity/WPEP2-spec.md` — Linux in-world process capture + provisioning/caps/truncation
  - `docs/project_management/next/world_process_exec_tracing_parity/WPEP3-spec.md` — redaction hardening + argv/env capture

- Contracts:
  - `docs/project_management/next/world_process_exec_tracing_parity/contract.md` — operator-facing contract summary + invariants
  - `docs/project_management/next/world_process_exec_tracing_parity/PROTOCOL.md` — host↔world-agent API and transport payloads
  - `docs/project_management/next/world_process_exec_tracing_parity/SCHEMA.md` — trace event families + fields + redaction/caps schema
...
| --- | --- | --- |
| Operator-facing contract | `docs/project_management/next/world_process_exec_tracing_parity/contract.md` | new event families, invariants, defaults, “safe-by-default” stance |
...
| Smoke validation | `docs/project_management/next/world_process_exec_tracing_parity/smoke/*` | automated validation commands; expected pass/fail |
