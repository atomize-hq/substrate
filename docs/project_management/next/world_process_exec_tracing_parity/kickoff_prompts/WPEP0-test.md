...
## Scope
- Tests for WPEP0 behaviors in `docs/project_management/next/world_process_exec_tracing_parity/WPEP0-spec.md`.
...
3. If task metadata is missing, stop and ask the operator to run:
   ...
   - `make triad-task-start FEATURE_DIR="docs/project_management/next/world_process_exec_tracing_parity" TASK_ID="WPEP0-test"`
