...
- Smoke script: `docs/project_management/next/doctor_scopes/smoke/macos-smoke.sh`
...
3. If `.taskmeta.json` is missing or mismatched, stop and ask the operator to run:
   - `make triad-task-start FEATURE_DIR="docs/project_management/next/doctor_scopes" TASK_ID="DS0-integ-macos"`
