...
3. On the orchestration branch, update `docs/project_management/next/doctor_scopes/tasks.json` and add the END entry to `docs/project_management/next/doctor_scopes/session_log.md`; commit docs (`docs: finish DS0-test`).
