...
- `docs/project_management/next/world-first-repl-persistent-pty/decision_register.md` (DR-07, DR-21, DR-22, DR-23)
...
## Acceptance criteria
- World-agent passes the per-exec protocol compliance tests defined in `docs/project_management/next/world-first-repl-persistent-pty/requirements_traceability.md`.
