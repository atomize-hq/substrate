...
**Date:** 2026-01-02  
**Status:** Accepted  
**Related docs:** `docs/project_management/next/ADR-0005-workspace-config-precedence-over-env.md`, `docs/project_management/next/policy_and_config_precedence/PCP0-spec.md`
