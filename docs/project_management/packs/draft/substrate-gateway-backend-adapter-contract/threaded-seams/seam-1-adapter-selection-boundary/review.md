...
flowchart TB
  ...
  C2 --> StatusSchema["docs/contracts/substrate-gateway-status-schema.md"]
  C2 --> Operator["docs/contracts/substrate-gateway-operator-contract.md"]
...
- `C-01` now has a canonical baseline at `docs/contracts/substrate-gateway-backend-adapter-selection.md`.
...
- **Contract gate**: passed
  - `C-01` is anchored in `docs/contracts/substrate-gateway-backend-adapter-selection.md`.
...
- **What must be true before downstream promotion is legal**:
  - `C-01` exists at `docs/contracts/substrate-gateway-backend-adapter-selection.md`.
