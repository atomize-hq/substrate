...
For `SEAM-1` (active) and `SEAM-2` (next), the authoritative pre-exec review artifact remains the seam-local `threaded-seams/.../review.md` that will be created during downstream seam decomposition.
