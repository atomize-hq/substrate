...
1. Verify you are in `wt/llm-and-agent-identity-tuple-and-deployment-posture-laitdp0-code` on branch `llm-and-agent-identity-tuple-and-deployment-posture-laitdp0-code` and that `.taskmeta.json` exists.
...
3. If `.taskmeta.json` is missing or mismatched, stop and ask the operator to run:
   ...
   - `make triad-task-start FEATURE_DIR="docs/project_management/packs/draft/llm-and-agent-identity-tuple-and-deployment-posture" TASK_ID="LAITDP0-code"`
...
2. From inside the worktree, run: `make triad-task-finish TASK_ID="LAITDP0-code"`.
