# Kickoff: LAITDP2-integ-core (integration core)

## Scope
- Merge the LAITDP2 code and test branches and make the core integration branch green before CP2.
...
1. Verify you are in `wt/llm-and-agent-identity-tuple-and-deployment-posture-laitdp2-integ-core` on branch `llm-and-agent-identity-tuple-and-deployment-posture-laitdp2-integ-core` and that `.taskmeta.json` exists.
...
3. If `.taskmeta.json` is missing or mismatched, stop and ask the operator to run:
   - `make triad-task-start FEATURE_DIR="docs/project_management/packs/draft/llm-and-agent-identity-tuple-and-deployment-posture" TASK_ID="LAITDP2-integ-core"`
...
- Finish this task before running `CP2-ci-checkpoint`.

## End Checklist
1. Ensure the merged state is committed and local integration gates are green.
2. From inside the worktree, run: `make triad-task-finish TASK_ID="LAITDP2-integ-core"`.
