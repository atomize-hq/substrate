...
## Scope
- Resolve Windows follow-up work after `CP2-ci-checkpoint`.
...
## End Checklist
1. Ensure Windows parity is green and capture the run id or command evidence from CP2 follow-up work.
