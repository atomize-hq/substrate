...
| Global protocol token `substrate.agent.session` | `docs/project_management/adrs/draft/ADR-0042-llm-and-agent-identity-tuple-and-deployment-posture.md` | protocol identity reused by agent-hub pure-agent records |
