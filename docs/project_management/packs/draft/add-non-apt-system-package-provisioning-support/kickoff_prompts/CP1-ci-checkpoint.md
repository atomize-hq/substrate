...
## Scope
- Run the cross-platform CI gates for the `NASP0`-`NASP2` checkpoint group.
...
3. Confirm `NASP2-integ-core` is completed and pushed.
...
- `make feature-smoke FEATURE_DIR="docs/project_management/packs/draft/add-non-apt-system-package-provisioning-support" PLATFORM=behavior SMOKE_SLICE_ID="NASP2" RUNNER_KIND=self-hosted WORKFLOW_REF="feat/add-non-apt-system-package-provisioning-support" REMOTE=origin CLEANUP=1 RUN_INTEG_CHECKS=0`
