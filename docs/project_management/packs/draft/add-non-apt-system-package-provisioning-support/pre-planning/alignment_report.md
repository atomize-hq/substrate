...
- Shared contract ownership is still split across existing docs (sources: `docs/project_management/packs/draft/add-non-apt-system-package-provisioning-support/pre-planning/spec_manifest.md#L358`)
- ADR-0033 still points at stale spec paths (sources: `docs/project_management/packs/draft/add-non-apt-system-package-provisioning-support/pre-planning/spec_manifest.md#L362`)
- Arch-family success evidence remains manual-only on macOS (sources: `docs/project_management/packs/draft/add-non-apt-system-package-provisioning-support/pre-planning/spec_manifest.md#L366`)
