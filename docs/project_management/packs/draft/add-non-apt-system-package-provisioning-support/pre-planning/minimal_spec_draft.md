...
1. DR-0002 — Pin a deterministic in-world probe algorithm
...
2. DR-0003 — Pin the deterministic pacman invocation contract
...
3. DR-0004 — Pin the mismatch policy
