# Review Surfaces - dev-install-world-service-staging
...
flowchart LR
  ...
  DI --> BIN1[target/bin/world-service]
  DI --> BIN2[target/bin/linux/world-service]
  ...
  VDIR --> P1{bin/world-service exists?}
  P1 -->|yes| RUN[launch helper / verify]
  P1 -->|no| P2{bin/linux/world-service exists?}
  P2 -->|yes| RUN
...
flowchart TB
  ...
  VERSION --> ROOT[target/bin/world-service]
  VERSION --> FALLBACK[target/bin/linux/world-service]
