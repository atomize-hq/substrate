# dev-install-world-service-staging - seam extraction

Source: `dev-install-world-service-staging.zip`
...
2. then stage `world-service` during Linux dev-install `--no-world` using that shared path rule,
