...
- **Landed evidence**:
  - `8cba8d5a` published the contract-to-locus map in `docs/project_management/packs/draft/dev-install-world-service-staging-fse/threaded-seams/seam-1-standard-version-dir-preflight-deterministic-remediation/slice-1-contract-definition-runtime-preflight.md`, freezing the `C-01`, `C-02`, and `C-03` mapping to the runtime surface and downstream closeout path.
