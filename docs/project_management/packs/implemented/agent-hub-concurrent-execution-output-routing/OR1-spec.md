...
3) Deterministic warning records for:
   ...
   - Telemetry source of truth: `docs/project_management/packs/active/agent-hub-concurrent-execution-output-routing/telemetry-spec.md`
...
- Smoke scripts exist, are runnable, and pass on their target platforms:
  - Linux: `bash docs/project_management/packs/active/agent-hub-concurrent-execution-output-routing/smoke/linux-smoke.sh` → exit `0`
  - macOS: `bash docs/project_management/packs/active/agent-hub-concurrent-execution-output-routing/smoke/macos-smoke.sh` → exit `0`
  - Windows: `pwsh -NoProfile -File docs/project_management/packs/active/agent-hub-concurrent-execution-output-routing/smoke/windows-smoke.ps1` → exit `0`
