...
- `docs/project_management/packs/active/world-deps-host-visible-hardening/decision_register.md` (DR-0006, DR-0010)
...
`docs/project_management/packs/active/world-deps-host-visible-hardening/smoke/_core.sh` MUST include a WDH3 slice assertion that the scaffold exists after bootstrap under a fresh `SUBSTRATE_HOME`.
