...
**Date:** 2026-02-15  
**Status:** Accepted  
**Related docs:** `docs/project_management/adrs/implemented/ADR-0011-world-deps-packages-bundles-contract.md` (Appendix A), `docs/project_management/packs/active/world-deps-host-visible-hardening/WDH0-spec.md`
...
- Implement sanitized env construction for all `--world` pathways (PTY + non-PTY): `docs/project_management/packs/active/world-deps-host-visible-hardening/tasks.json` (`WDH0-code`).
- Add unit + integration tests asserting sanitized PATH/HOME/XDG behavior: `docs/project_management/packs/active/world-deps-host-visible-hardening/tasks.json` (`WDH0-test`, `WDH0-integ`).
...
**Date:** 2026-02-15  
**Status:** Accepted  
**Related docs:** `docs/project_management/packs/active/world-deps-host-visible-hardening/WDH0-spec.md`
...
**Date:** 2026-02-15  
**Status:** Accepted  
**Related docs:** `docs/project_management/adrs/implemented/ADR-0011-world-deps-packages-bundles-contract.md` (Inventory schema), `docs/project_management/packs/active/world-deps-host-visible-hardening/WDH1-spec.md`
...
**Date:** 2026-02-15  
**Status:** Accepted  
**Related docs:** `docs/project_management/packs/active/world-deps-host-visible-hardening/WDH1-spec.md`
...
**Date:** 2026-02-15  
**Status:** Accepted  
**Related docs:** `docs/project_management/packs/active/world-deps-host-visible-hardening/WDH2-spec.md`
...
**Date:** 2026-02-15  
**Status:** Accepted  
**Related docs:** `docs/project_management/adrs/implemented/ADR-0011-world-deps-packages-bundles-contract.md` (Appendix A), `docs/project_management/packs/active/world-deps-host-visible-hardening/WDH3-spec.md`
...
**Date:** 2026-02-15  
**Status:** Accepted  
**Related docs:** `docs/project_management/packs/active/world-deps-host-visible-hardening/WDH0-spec.md`, `docs/project_management/packs/active/world-deps-host-visible-hardening/WDH2-spec.md`
...
**Date:** 2026-02-15  
**Status:** Accepted  
**Related docs:** `docs/project_management/packs/active/world-deps-host-visible-hardening/WDH3-spec.md`
