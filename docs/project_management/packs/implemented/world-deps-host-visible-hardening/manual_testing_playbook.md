...
- Linux: `docs/project_management/packs/active/world-deps-host-visible-hardening/smoke/linux-smoke.sh`
- macOS: `docs/project_management/packs/active/world-deps-host-visible-hardening/smoke/macos-smoke.sh`
- Windows: `docs/project_management/packs/active/world-deps-host-visible-hardening/smoke/windows-smoke.ps1` (WSL-backed where applicable)
