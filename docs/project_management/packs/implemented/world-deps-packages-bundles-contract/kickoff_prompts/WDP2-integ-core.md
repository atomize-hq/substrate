...
- If this machine matches a behavior platform, run the local smoke script before finishing:
  - Linux: `bash docs/project_management/packs/active/world-deps-packages-bundles-contract/smoke/linux-smoke.sh`
  - macOS: `bash docs/project_management/packs/active/world-deps-packages-bundles-contract/smoke/macos-smoke.sh`
