...
1. Verify you are in the task worktree `wt/world-deps-packages-bundles-contract-wdp5-code` on branch `world-deps-packages-bundles-contract-wdp5-code` and that `.taskmeta.json` exists.
...
1. From inside the worktree, run: `make triad-task-finish TASK_ID="WDP5-code"`
