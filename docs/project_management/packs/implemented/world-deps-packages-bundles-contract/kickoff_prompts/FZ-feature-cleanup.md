...
- `<git-common-dir>/triad/features/world-deps-packages-bundles-contract/worktrees.json`

Dry-run (recommended first):
- `make triad-feature-cleanup FEATURE_DIR="docs/project_management/packs/active/world-deps-packages-bundles-contract" DRY_RUN=1 REMOVE_WORKTREES=1 PRUNE_LOCAL=1`

Real run:
- `make triad-feature-cleanup FEATURE_DIR="docs/project_management/packs/active/world-deps-packages-bundles-contract" REMOVE_WORKTREES=1 PRUNE_LOCAL=1`

Remote branch pruning (optional, destructive):
- `make triad-feature-cleanup FEATURE_DIR="docs/project_management/packs/active/world-deps-packages-bundles-contract" PRUNE_REMOTE=origin PRUNE_LOCAL=1 REMOVE_WORKTREES=1`
