# dev-install-world-service-staging — plan

## Scope
- Feature directory: `docs/project_management/packs/draft/dev-install-world-service-staging/`
- Orchestration branch: `feat/dev-install-world-service-staging`
- Canonical planning inputs:
  ...
  - `docs/project_management/packs/draft/dev-install-world-service-staging/pre-planning/workstream_triage.md`
...
### DIWAS1
- Objective:
  - stage `world-service` during Linux `dev-install-substrate.sh --no-world` and validate the selected-profile refresh rule
- Tasks:
  - `DIWAS1-code`
  - `DIWAS1-test`
  - `DIWAS1-integ-core`
...
## Validation commands
- Planning validators:
  - `python3 docs/project_management/system/scripts/planning/validate_tasks_json.py --feature-dir "docs/project_management/packs/draft/dev-install-world-service-staging"`
  - `python3 docs/project_management/system/scripts/planning/validate_slice_specs.py --feature-dir "docs/project_management/packs/draft/dev-install-world-service-staging"`
  - `python3 docs/project_management/system/scripts/planning/validate_ci_checkpoint_plan.py --feature-dir "docs/project_management/packs/draft/dev-install-world-service-staging"`
  - `make planning-lint FEATURE_DIR="docs/project_management/packs/draft/dev-install-world-service-staging"`
- Work-lift evidence:
  - `make pm-lift-pack PACK="docs/project_management/packs/draft/dev-install-world-service-staging"`
  - `make pm-lift-pack PACK="docs/project_management/packs/draft/dev-install-world-service-staging" EMIT_JSON=1`
  - `PM_LIFT_ADVISORY=1 make planning-lint FEATURE_DIR="docs/project_management/packs/draft/dev-install-world-service-staging"`
