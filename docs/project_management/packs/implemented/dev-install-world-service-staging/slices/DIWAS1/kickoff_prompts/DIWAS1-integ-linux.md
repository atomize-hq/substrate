...
2. Verify you are in the task worktree `wt/dev-install-world-service-staging-diwas1-integ-linux` on branch `dev-install-world-service-staging-diwas1-integ-linux` and that `.taskmeta.json` exists at the worktree root.
