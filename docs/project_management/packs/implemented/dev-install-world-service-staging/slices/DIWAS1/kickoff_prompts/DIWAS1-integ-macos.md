...
2. Verify you are in the task worktree `wt/dev-install-world-service-staging-diwas1-integ-macos` on branch `dev-install-world-service-staging-diwas1-integ-macos` and that `.taskmeta.json` exists at the worktree root.
