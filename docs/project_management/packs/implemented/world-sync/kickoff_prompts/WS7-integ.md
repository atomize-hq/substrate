...
3. If `.taskmeta.json` is missing or mismatched, stop and ask the operator to run:
   - `make triad-task-start FEATURE_DIR="docs/project_management/packs/active/world-sync" TASK_ID="WS7-integ"`
...
- Complete the slice closeout gate report:
  - `docs/project_management/packs/active/world-sync/WS7-closeout_report.md` (e.g., `docs/project_management/packs/active/world-sync/WS7-closeout_report.md`)
