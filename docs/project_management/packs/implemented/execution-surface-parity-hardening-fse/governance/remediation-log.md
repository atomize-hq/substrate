# Remediation Log - execution-surface-parity-hardening
...
- cross-surface issues must still pick one owning seam rather than defaulting to a generic docs or platform bucket
