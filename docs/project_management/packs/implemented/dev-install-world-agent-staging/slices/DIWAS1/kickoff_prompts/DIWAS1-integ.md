...
1. Verify you are in the task worktree `wt/dev-install-world-agent-staging-diwas1-integ` on branch `dev-install-world-agent-staging-diwas1-integ` and that `.taskmeta.json` exists at the worktree root.
