...
1. Verify you are in the task worktree `wt/dev-install-world-agent-staging-diwas0-integ` on branch `dev-install-world-agent-staging-diwas0-integ` and that `.taskmeta.json` exists at the worktree root.
