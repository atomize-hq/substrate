...
Deprecated:
- Replaced by `docs/project_management/packs/active/warn-config-global-show-workspace-overrides/impact_map.md`
...
- Linux: `docs/project_management/packs/active/warn-config-global-show-workspace-overrides/smoke/linux-smoke.sh`
- macOS: `docs/project_management/packs/active/warn-config-global-show-workspace-overrides/smoke/macos-smoke.sh`
- Windows: `docs/project_management/packs/active/warn-config-global-show-workspace-overrides/smoke/windows-smoke.ps1`

CI dispatch entrypoint:
- `scripts/ci/dispatch_feature_smoke.sh --feature-dir docs/project_management/packs/active/warn-config-global-show-workspace-overrides`
