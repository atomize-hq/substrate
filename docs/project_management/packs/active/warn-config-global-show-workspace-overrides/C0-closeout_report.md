# Slice Closeout Gate Report — warn-config-global-show-workspace-overrides / C0
...
- Evidence ledger path (if used): `docs/project_management/packs/active/warn-config-global-show-workspace-overrides/logs/C0/ci-audit/ledger.jsonl`
