...
2. Read: `docs/project_management/packs/active/world_process_exec_tracing_parity/plan.md`, `docs/project_management/packs/active/world_process_exec_tracing_parity/tasks.json`, `docs/project_management/packs/active/world_process_exec_tracing_parity/session_log.md`, WPEP0 spec, decision register DR references.
