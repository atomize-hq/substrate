...
This document is the durable canonical contract reference for the gateway adapter protocol at the
Substrate boundary. It defines the deterministic lifecycle from a selected stable backend id to
