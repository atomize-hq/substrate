...
- [ ] Task: Lock the checkpoint-calibration metric contract
...
- [ ] Task: Add deterministic session summary metric helpers
...
- [ ] Task: Compute checkpoint interval metrics from adjacent boundaries
...
- [ ] Task: Add per-session diagnostic metrics from existing analyzer context
...
- [ ] Task: Render the operator summary in the agreed compact format
...
- [ ] Task: Validate the checkpoint-calibration summary on the bounded real-session smoke
...
- [ ] Task: Document next-level blocked metrics and contract gaps
