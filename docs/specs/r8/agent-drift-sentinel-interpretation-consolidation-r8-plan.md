...
ONLY / ACTIVE PACKET `none` / ALL IMPLEMENTATION UNSTARTED / TRANSITION UPDATE AWAITING FRESH
INDEPENDENT REVIEW**.
...
hash or review result, does not claim to be clean, and starts no implementation. R8-IMPLEMENT entry
