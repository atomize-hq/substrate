...
sentinel or other R7-6 implementation has started. R8 remains blocked, and the known R7-6.1
workspace-clippy sentinel-constructor witness remains preserved. Prepared selectors `PHASE_ID:
R7-6` / `ACTIVE_PACKET: none` are eligible but have not been invoked.
