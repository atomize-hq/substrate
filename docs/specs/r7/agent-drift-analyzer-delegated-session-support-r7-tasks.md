...
`CTX-R7-03`. R7-2 is complete. Only R7-3 is active at entry with packet `none`; current transition
receipt pending fresh independent review. `R7-3.1` is next, unchecked, and unstarted; R7-3 analyzer/
