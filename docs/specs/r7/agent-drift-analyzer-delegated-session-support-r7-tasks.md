...
gate and proving `CTX-R7-04`. R7-3 is complete. Only R7-4 is active at entry with packet `none`; the
current transition candidate is pending fresh independent review. `R7-4.1` is next, unchecked, and
