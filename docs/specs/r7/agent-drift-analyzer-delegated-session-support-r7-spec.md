...
## Implementation State — R7 Complete / R8-SPEC Complete / R8-IMPLEMENT At Entry
...
R7 must continue to preserve the stable ordinary single-session baseline and must not absorb
baseline scorer semantics.
