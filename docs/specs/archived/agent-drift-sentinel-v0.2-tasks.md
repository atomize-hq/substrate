...
- [x] Task: Implement replay-mode checkpoint loading
...
- [x] Task: Implement scheduler state and trigger classes
...
- [x] Task: Implement replay-mode operator summaries
...
- [x] Task: Separate visible warnings from silent checkpoint handling
...
- [x] Task: Implement optional model adjudication request shaping
...
- [x] Task: Implement safe adjudication fallback behavior
...
- [x] Task: Wire the thin CLI for replay mode
...
- [x] Task: Gate replay-mode usefulness before live-mode work starts
...
- [x] Task: Gate live-mode entry and only then scope live integration work
