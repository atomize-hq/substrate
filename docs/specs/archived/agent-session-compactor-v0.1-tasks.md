...
- [x] Task: Define row, audit, and manifest core types
...
- [x] Task: Implement Codex-home resolution and session discovery
...
- [x] Task: Implement rollout ingestion via `unified-agent-api-codex`
...
- [x] Task: Gate real-session ingestion and decide if any upstream parser work is required
...
- [x] Task: Implement normalization from parser events into `CompactionRow`
...
- [x] Task: Implement deterministic canonicalization and hashing
...
- [x] Task: Implement exact dedupe and dedupe-audit emission
...
- [x] Task: Implement manifest and bundle export
...
- [x] Task: Gate end-to-end validation and freeze the downstream artifact contract
