...
archetype-equivalence controls are complete;
...
- [x] **R6-C.1.0.1 — Commit and independently review this SPEC/PLAN/TASKS family.**
  ...
  - Sole next authorized action: execute `R6-C.1.2.7`, the reviewed `truth_grounding_gap` family
    checkpoint. Do not start a `wrong_plan_branch` row, replay, a gap packet, or a production change
    first.
