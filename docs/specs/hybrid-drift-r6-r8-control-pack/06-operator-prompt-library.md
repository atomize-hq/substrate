...
full analyzer `422 / 422`, plus green formatting, analyzer clippy, and diff checks. The current
operator action is fresh independent review of the checkpoint-doc receipt only. Do not prepare or
invoke an R7-5 Prompt 1 until that receipt is fresh-review-clean and a separate narrow phase
transition is landed and independently reviewed.
