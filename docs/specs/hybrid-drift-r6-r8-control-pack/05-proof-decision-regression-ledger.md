...
**Ledger status:** ACTIVE — `R6-GAP-DET-OPAQUE-PARENT` (packet-docs gate only)
...
| `CTX-R6-04` | Opaque delegated parent does not become child thrash | PRESERVED RED / ACTIVE GAP | Exact control `dead_end_thrash_keeps_opaque_parent_orchestration_clear_without_child_activity` reached `ParentVisibleOrchestration` but failed the locked triple: actual `0 / Medium / Cleared`, unflagged, empty evidence, versus required `0 / Low / Cleared`. | Create and freshly review the three canonical `R6-GAP-DET-OPAQUE-PARENT` packet docs atomically; do not execute the gap or change production first. | `R6-GAP-DET-OPAQUE-PARENT` |
...
|---|---|---|---|---|---|---|
| `R6-GAP-DET-OPAQUE-PARENT` | `CTX-R6-04` — `dead_end_thrash_keeps_opaque_parent_orchestration_clear_without_child_activity` | TO CREATE `docs/specs/r6/R6-GAP-DET-OPAQUE-PARENT/R6-GAP-DET-OPAQUE-PARENT-spec.md`<br>TO CREATE `docs/specs/r6/R6-GAP-DET-OPAQUE-PARENT/R6-GAP-DET-OPAQUE-PARENT-plan.md`<br>TO CREATE `docs/specs/r6/R6-GAP-DET-OPAQUE-PARENT/R6-GAP-DET-OPAQUE-PARENT-tasks.md` | ACTIVE | `R6-C.1-CONTROLS` | `R6-GAP-TGG-TRUTH-PATH-ACTION` | Witness `87409b39a`; controls wall `5618f7864`. |
