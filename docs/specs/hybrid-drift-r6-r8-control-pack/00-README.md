...
implementation and checkpoint are complete, but only R7-1 remains active with packet `none` pending
checkpoint-doc review and a separate phase-transition review. `R7-2..R7-6` and R8 remain blocked;
no R7-2 work has started.
