...
new_experiment = "01a0033f-9fa7-700c-b0b3-4ad0a8ed372b"
new_scopes = [
...
if len({new_experiment, *new_scopes, old_experiment, *old_scopes}) != 6:
...
if old_experiment in root_source or any(scope in root_source for scope in old_scopes):
...
if old_experiment in freeze_source or any(scope in freeze_source for scope in old_scopes):
