...
pub use managed_artifact::{
    ...
    canonical_mac_publisher_service_state_record_v1, canonical_managed_action_prepared_record_v1,
    ...
    MacPublisherServiceStateRecordV1, ManagedActionPreparedRecordV1,
