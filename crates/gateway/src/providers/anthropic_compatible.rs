...
fn strip_non_anthropic_thinking(request: &mut GatewayRequest) {
...
fn strip_all_thinking_signatures(request: &mut GatewayRequest) {
    let mut stripped_count = 0;
...
fn remove_empty_messages(request: &mut GatewayRequest) {
...
fn sanitize_tool_use_ids(request: &mut GatewayRequest, is_anthropic_target: bool) {
...
#[async_trait]
impl super::GatewayProvider for AnthropicCompatibleProvider {
