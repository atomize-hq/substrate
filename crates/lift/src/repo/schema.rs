...
pub(crate) const DIFF_MANIFEST_V1_SCHEMA_ID: &str =
    "https://schemas.substrate.dev/lift/repo/diff_manifest.v1.json";

pub(crate) const DIFF_MANIFEST_V1_SCHEMA_VERSION: u32 = 1;

pub(crate) const DIFF_MANIFEST_V1_SCHEMA_FILE: &str = "diff_manifest.v1.json";

pub(crate) const DIFF_MANIFEST_V1_SCHEMA_JSON: &str =
    include_str!("../../schemas/repo/diff_manifest.v1.json");
