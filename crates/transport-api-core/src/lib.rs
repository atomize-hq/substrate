//! Agent API core: service trait and router builder shared by host-proxy and world-service.
...
use transport_api_types::{ApiError, ErrorResponse, ExecuteRequest, ExecuteResponse};

// Service trait implemented by both host-proxy (delegating) and world-service (executing)
