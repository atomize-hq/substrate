...
pub struct PersistentStartSessionRecord {
    ...
    pub shared_world: Option<transport_api_types::SharedWorldOwnerSpec>,
...
pub struct ReplWorldAgentRecords {
    ...
    pub member_dispatch_requests: Vec<transport_api_types::ExecuteRequest>,
    pub member_turn_submit_requests: Vec<transport_api_types::MemberTurnSubmitRequestV1>,
    pub execute_cancel_requests: Vec<transport_api_types::ExecuteCancelRequestV1>,
}
...
impl ReplWorldAgentStub {
    ...
    fn start_with_overrides(
            ...
            rt.block_on(async move {
                ...
                while !shutdown_for_thread.load(Ordering::SeqCst) {
                    ...
                    if first_line.starts_with("POST /v1/execute/stream ") {
                        let parsed: transport_api_types::ExecuteRequest =
                    ...
                    if first_line.starts_with("POST /v1/execute/cancel ") {
                        let parsed: transport_api_types::ExecuteCancelRequestV1 =
                            match serde_json::from_slice(&body) {
                                Ok(p) => p,
                                Err(_) => {
                                    write_http_json(&mut stream, "400 Bad Request", r#"{"error":"bad_request","message":"invalid json"}"#).await;
                    ...
                    if first_line.starts_with("POST /v1/execute ") {
                        ...
                        let shared_world = parsed.shared_world.as_ref().map(|request| {
                            let generation = match request.action {
                                transport_api_types::SharedWorldOwnerAction::AttachOrCreate => 0,
                                transport_api_types::SharedWorldOwnerAction::ReplaceExpectedGeneration {
                                    expected_generation,
                                    ..
        ...
        // `ensure_world_service_ready()`): wait until the socket responds with 200.
