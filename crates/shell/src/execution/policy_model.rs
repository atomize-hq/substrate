...
fn reset_policy_patch_key(patch: &mut PolicyPatch, key: &str) -> Result<bool> {
    match key {
        ...
        "agents.world_dispatch.obligations.approval_response_allowed" => Ok(patch
            ...
            .take()
            .is_some()),
        "agents.world_dispatch.obligations.clarification_response_allowed" => Ok(patch
            .agents
            .world_dispatch
            .obligations
            .clarification_response_allowed
        ...
        "agents.world_dispatch.obligations.follow_up_allowed" => Ok(patch
            ...
            .take()
            .is_some()),
        "agents.world_dispatch.obligations.blocked_allowed" => Ok(patch
            .agents
            .world_dispatch
            .obligations
            .blocked_allowed
...
fn apply_update_to_patch(patch: &mut PolicyPatch, update: &ConfigUpdate) -> Result<bool> {
    match update.key.as_str() {
        ...
        "agents.world_dispatch.obligations.clarification_response_allowed" => apply_bool_opt(
            &mut patch
                .agents
                .world_dispatch
                .obligations
        ...
        "agents.world_dispatch.obligations.follow_up_allowed" => apply_bool_opt(
            &mut patch.agents.world_dispatch.obligations.follow_up_allowed,
            &update.op,
            &update.value,
        ),
        "agents.world_dispatch.obligations.blocked_allowed" => apply_bool_opt(
            &mut patch.agents.world_dispatch.obligations.blocked_allowed,
            &update.op,
            &update.value,
        ),
...
mod tests {
    ...
    fn explicit_bootstrap_home_explain_uses_selected_global_policy_path() {
        let selected = TempDir::new().expect("selected bootstrap home");
    ...
    fn policy_patch_accepts_agents_world_dispatch_keys() {
        ...
        let updates = vec![
            ...
            ConfigUpdate {
                key: "agents.world_dispatch.obligations.clarification_response_allowed".to_string(),
                op: UpdateOp::Set,
                value: "true".to_string(),
            },
            ConfigUpdate {
            ...
            ConfigUpdate {
                key: "agents.world_dispatch.obligations.blocked_allowed".to_string(),
                op: UpdateOp::Set,
                value: "false".to_string(),
            },
        ];
        ...
        assert_eq!(
            patch.agents.world_dispatch.obligations.blocked_allowed,
            Some(false)
        );
    }
