...
mod tests {
    ...
    fn test_default_policy() {
        ...
        assert!(!policy.cmd_allowed.is_empty() || policy.cmd_denied.len() > 0);
    }

    #[test]
    fn test_policy_merge() {
        let mut base = Policy::default();
        base.fs_write = vec!["/tmp/*".to_string()];
