...
pub(crate) const OVERRIDE_WORLD_EXEC_GUARD_ENV: &str = "SUBSTRATE_OVERRIDE_WORLD_EXEC_GUARD";
pub(crate) const OVERRIDE_WORLD_EXEC_GUARD_DENY_CONTAINS_ENV: &str =
...
#[derive(Debug, Clone)]
pub(crate) struct WorldExecGuardDeny {
    pub(crate) resolved_executable: String,
    pub(crate) matched_substring: String,
}
...
pub(crate) fn deny_message(deny: &WorldExecGuardDeny) -> String {
    format!(
