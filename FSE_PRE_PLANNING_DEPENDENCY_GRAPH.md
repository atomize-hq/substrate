...
| PP1 | PP0 handoff exists | stable input set from PP0 plus any helper research it chooses to consume | PP2 |
| PP2 | PP1 handoff exists | canonical `scope_brief.md` | PP3, PP4, PP5 |
| PP3a | PP2 handoff exists | none; research only | PP3 |
| PP3b | PP2 handoff exists | none; research only | PP3 |
| PP3 | PP2 handoff exists | canonical `seam_map.md` and seam briefs plus any helper research it chooses to consume | PP4, PP5, PP6 |
...
- `spec_manifest.md` derives from `scope_brief.md` and `threading.md`
