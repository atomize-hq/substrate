...
This project is indexed by GitNexus as **substrate** (30520 symbols, 59474 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
