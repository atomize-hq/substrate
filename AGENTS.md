...
This project is indexed by GitNexus as **substrate-current** (35909 symbols, 72346 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
