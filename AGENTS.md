...
This project is indexed by GitNexus as **substrate** (27482 symbols, 55505 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
