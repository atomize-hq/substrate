...
This project is indexed by GitNexus as **substrate** (25873 symbols, 51850 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
