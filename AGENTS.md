...
This project is indexed by GitNexus as **substrate** (46052 symbols, 69611 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
