...
This project is indexed by GitNexus as **substrate** (49483 symbols, 76428 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
