...
This project is indexed by GitNexus as **substrate** (27222 symbols, 54820 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
