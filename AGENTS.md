...
This project is indexed by GitNexus as **substrate** (25507 symbols, 50930 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
