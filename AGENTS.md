...
This project is indexed by GitNexus as **substrate** (49740 symbols, 77046 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
