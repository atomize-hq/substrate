...
This project is indexed by GitNexus as **substrate** (45335 symbols, 71182 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
