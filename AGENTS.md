...
This project is indexed by GitNexus as **substrate** (27549 symbols, 54651 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
