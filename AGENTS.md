...
This project is indexed by GitNexus as **substrate** (27765 symbols, 55018 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
