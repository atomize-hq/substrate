...
This project is indexed by GitNexus as **substrate** (26434 symbols, 53134 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
