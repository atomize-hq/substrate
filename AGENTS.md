...
This project is indexed by GitNexus as **substrate** (28243 symbols, 57024 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
