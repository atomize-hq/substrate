...
This project is indexed by GitNexus as **substrate** (30781 symbols, 61297 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
