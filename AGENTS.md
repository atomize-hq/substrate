...
This project is indexed by GitNexus as **substrate** (26003 symbols, 56071 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
