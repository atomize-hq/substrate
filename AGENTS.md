...
This project is indexed by GitNexus as **substrate** (30103 symbols, 60312 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
