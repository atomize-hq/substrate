...
This project is indexed by GitNexus as **substrate** (30524 symbols, 59368 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
