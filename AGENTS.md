...
This project is indexed by GitNexus as **substrate** (29351 symbols, 58629 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
