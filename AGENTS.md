...
This project is indexed by GitNexus as **substrate** (29784 symbols, 59726 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
