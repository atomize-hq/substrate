...
This project is indexed by GitNexus as **substrate** (26301 symbols, 53101 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
