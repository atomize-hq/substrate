...
This project is indexed by GitNexus as **substrate** (26654 symbols, 53125 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
