...
This project is indexed by GitNexus as **substrate** (26657 symbols, 54525 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
