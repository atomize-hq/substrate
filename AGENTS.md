...
This project is indexed by GitNexus as **substrate** (30533 symbols, 59496 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
