...
This project is indexed by GitNexus as **substrate** (30539 symbols, 59508 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
