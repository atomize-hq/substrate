...
This project is indexed by GitNexus as **substrate** (28486 symbols, 57294 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
