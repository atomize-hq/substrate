...
This project is indexed by GitNexus as **substrate** (27130 symbols, 54543 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
