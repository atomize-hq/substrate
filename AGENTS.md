...
This project is indexed by GitNexus as **substrate** (49748 symbols, 77062 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
