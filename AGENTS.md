...
This project is indexed by GitNexus as **substrate** (25568 symbols, 51132 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
