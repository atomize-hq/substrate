...
This project is indexed by GitNexus as **substrate** (30461 symbols, 60906 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
