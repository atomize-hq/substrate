...
This project is indexed by GitNexus as **substrate** (28185 symbols, 56924 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
