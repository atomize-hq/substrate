...
- Resolved feature dir: `.tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged/`
- Resolved ADR paths:
  - `.tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged/ADR-0001-fixture.md`
...
- Staged tracked-output candidates (write only these under logs):
  - `.tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged/logs/impact-map/staged/pre-planning/impact_map.md`
- Direct writes to canonical tracked paths are forbidden.
- Logs allowed (untracked only): `.tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged/logs/impact-map/`
...
You are the Impact Map agent for impact_map_invalid_staged.

Goal:
- Read the ADR(s) and `spec_manifest.md` for impact_map_invalid_staged.
- Produce `.tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged/pre-planning/impact_map.md` that is exhaustive about:
...
- Feature directory: `.tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged/`
- `spec_manifest.md`: `.tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged/pre-planning/spec_manifest.md`
...
0) Allowed writes:
   ...
   - Staged candidate (logs-only; promoted later by runner/wrapper): write/overwrite only `.tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged/logs/impact-map/staged/pre-planning/impact_map.md`.
   - Logs (untracked; scratch + orchestration handoff): you may write under `.tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged/logs/impact-map/**` only.
...
1) Overlap execution model (required):
   - Phase A (start immediately; logs only):
     ...
     - Write/overwrite scratch notes at: `.tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged/logs/impact-map/scratch.md`
     ...
     - If present, read upstream handoff notes as an input:
       - `.tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged/logs/spec-manifest/handoff.md`
   - Emit an orchestration handoff signal once Phase A is usable:
     - Write/overwrite: `.tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged/logs/impact-map/handoff.md`
...
2) Phase B (staged candidate write gate; required):
   - Before writing `.tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged/logs/impact-map/staged/pre-planning/impact_map.md`, poll until BOTH are true:
     - `.tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged/logs/spec-manifest/last_message.md` exists, and
     - `git status --porcelain=v1 -- ".tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged"` is empty.
...
3) Then write/overwrite `.tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged/logs/impact-map/staged/pre-planning/impact_map.md` using the template.
...
5) Closeout validation:
   - Do not write `.tmp_pm_script_tests/run_planning_agent/impact_map_invalid_staged/pre-planning/impact_map.md` directly.
