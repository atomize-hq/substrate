...
Bind this exact task identity before any action:

- increment_task_thread_id: 019fdd57-3a7e-7dc3-922e-9125801393bc
- increment_task_host_id: local
- exact_task_worktree: /Users/spensermcconnell/.codex/worktrees/9afb/substrate
...
- expected_base_commit: fc150213826b8b423f042b4591d6b8b1cb3ace20
- expected_base_tree: 02217ad2dbd106ae5befc60c8de862b6f3864647
- live target ref: origin refs/heads/feat/internal-host-orchestrator-world-dispatch-bootstrap = fc150213826b8b423f042b4591d6b8b1cb3ace20
- complete repository-local skill suite: 25 skills / 54 files / sha256 e3de93f358594033ed59696a9624d2d0ac2fd0c2aa7ddf4a532810a05b262282
- contract_sha256: sha256:3c6749aed81c19c6baf95bc701e641f7bd329ff76de59e79373685beed2d777e
- rendered_prompt_sha256: sha256:c20394e27d4a6b1b6b379925bab84af243066f4e043dd5a715483e35ba86b220
- model/reasoning for this task and every subagent/reviewer: gpt-5.6-terra / Extra High (xhigh)
- start_authorized: true

The initial prompt arrived with a shell-output wrapper around its text; treat that wrapper as transport noise only. The initialization barrier itself was authoritative and no work was authorized before this message.

Load `.agents/skills/using-agent-skills/SKILL.md` first and follow the complete hydrated repository-local suite. Do not use a global skill copy. Reverify identity/base/tree/remote/cleanliness and then execute only the full R3 contract below. End the task after sending exactly one terminal receipt to meta; the send must be your final tool action.

--- FULL RENDERED R3 PROMPT ---
