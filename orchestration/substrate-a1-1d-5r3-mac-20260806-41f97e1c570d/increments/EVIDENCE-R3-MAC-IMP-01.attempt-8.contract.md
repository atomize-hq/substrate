# EVIDENCE:R3-MAC-IMP-01 attempt-8 agent-operated native read-only contract

## Authority and source

- Orchestration: `substrate-a1-1d-5r3-mac-20260806-41f97e1c570d`.
- Evidence ID: `EVIDENCE:R3-MAC-IMP-01`.
- Dispatch nonce: `8c5f7e13d8f10d0e6744518a0b79bb4d575d4a6cb26483f2005fef8172c72fa2`.
...
## Attempt-8 authority, recovered source, and amendment 0040
...
hydrated repository-local skill digest, this attempt-8 nonce, exact source commit/tree/ref, and live
...
the canonical installer, receipts, and the final artifact must remain under the external attempt-8
nonce-scoped directory
`/Users/spensermcconnell/.codex/evidence/substrate-a1-1d-5r3-mac-20260806-41f97e1c570d/EVIDENCE-R3-MAC-IMP-01/8c5f7e13d8f10d0e6744518a0b79bb4d575d4a6cb26483f2005fef8172c72fa2/`.
...
## Attempt-8 mandatory recovery gates
...
The historical attempts 1-7 and their blocked artifacts are diagnostic only and cannot satisfy any gate. In
...
## Attempt-8 bound platform prerequisites
...
## Attempt-8 verified platform-preparation inputs
