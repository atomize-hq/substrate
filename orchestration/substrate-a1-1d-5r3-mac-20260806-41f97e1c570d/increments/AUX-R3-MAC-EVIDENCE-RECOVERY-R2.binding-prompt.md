META IDENTITY BINDING AND R2 START AUTHORITY

Bind this exact identity and begin only R2 now:

- task_thread_id: 019fdce6-3860-7bb2-8099-20c870f8d3e2
- task_host_id: local
- exact_task_worktree: /Users/spensermcconnell/.codex/worktrees/05f9/substrate
- orchestration_id: substrate-a1-1d-5r3-mac-20260806-41f97e1c570d
- dispatch_nonce: 49e8d36feff2e9ea0ef78ab92f14dc2680d3fe4e9ee2ffcd0badb8c1f113c41e
- complete_skill_suite_source: /Users/spensermcconnell/.codex/worktrees/eb49/substrate/.agents/skills
- complete_skill_suite_target: /Users/spensermcconnell/.codex/worktrees/05f9/substrate/.agents/skills
...
- authorized_increment: AUX-R3-MAC-EVIDENCE-RECOVERY-R2
- R3_through_R6_authorized_for_this_task: false
- native_or_host_mutation_authorized: false

Load `.agents/skills/using-agent-skills/SKILL.md` first and invoke the contract-selected hydrated
skills. Every subagent/reviewer uses `gpt-5.6-terra` at Extra High (`xhigh`). Preserve the donor,
protected worktrees, and this worktree on every block. Complete R2 and its causal review only. The
meta orchestrator alone may use standing authority to dispatch R3 after independent CLEAN landing
verification.
