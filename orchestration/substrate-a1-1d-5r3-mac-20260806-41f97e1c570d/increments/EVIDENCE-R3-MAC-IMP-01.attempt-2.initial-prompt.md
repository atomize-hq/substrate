...
- dispatch_nonce: 61f37af30a2a6d5e4aec55ead3875f9d027d44d5dabd1f39a260dc656029752a
...
# EVIDENCE:R3-MAC-IMP-01 attempt-2 agent-operated native read-only contract

## Authority and source

- Orchestration: `substrate-a1-1d-5r3-mac-20260806-41f97e1c570d`.
- Evidence ID: `EVIDENCE:R3-MAC-IMP-01`.
- Dispatch nonce: `61f37af30a2a6d5e4aec55ead3875f9d027d44d5dabd1f39a260dc656029752a`.
...
## Attempt-2 authority correction

Authority amendment `0004-agent-operated-native-evidence.json` controls this retry. The human user
...
Host and guest `sudo -n true` were independently verified before dispatch. The root-owned
...
`/Users/spensermcconnell/.codex/evidence/substrate-a1-1d-5r3-mac-20260806-41f97e1c570d/EVIDENCE-R3-MAC-IMP-01/61f37af30a2a6d5e4aec55ead3875f9d027d44d5dabd1f39a260dc656029752a/`.
...
6. Allocate two independent real controlling PTYs (host and guest), record their identities, compare
   the full fingerprint/challenge, and enter the exact literal confirmation through the agent-owned
   PTYs under the user's advance delegated authority. A pipe, ordinary non-TTY stdin, file, or
   environment-variable bypass is forbidden. Do not wait for the user.
