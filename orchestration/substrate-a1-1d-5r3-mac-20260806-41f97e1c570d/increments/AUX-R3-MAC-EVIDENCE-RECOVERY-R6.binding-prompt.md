...
- increment_task_thread_id: 019fded7-05c4-7c61-9f7d-5fc456bcda6d
- increment_task_host_id: local
- exact_task_worktree: /Users/spensermcconnell/.codex/worktrees/1bd8/substrate
- orchestration_id: substrate-a1-1d-5r3-mac-20260806-41f97e1c570d
- dispatch_nonce: 1b9fe0a5eee31553d83daa75ccdde591ea5a4b797a81f14c3f3d3d839bc9cd70
- expected_base_commit: a9626bc10a1737416c1d8f7f48630850118f3e6a
- expected_base_tree: 3f7cdf20125a847a3dfaa472d3797759b5cf6737
- live target: origin refs/heads/feat/internal-host-orchestrator-world-dispatch-bootstrap = a9626bc10a1737416c1d8f7f48630850118f3e6a
- complete repository-local skills: 25 skills / 54 files / sha256 e3de93f358594033ed59696a9624d2d0ac2fd0c2aa7ddf4a532810a05b262282
- contract_sha256: sha256:9f264105bfbc2d46206dc9b34a3d7570dbfa0a538d97400a64b9142908863334
- rendered_prompt_sha256: sha256:30356f18efc92cd54b16019bee37bc58adfeb52ffa4fa3cd0a0f5eeaed643dfd
- task/subagent/reviewer model: gpt-5.6-terra Extra High (xhigh)
- start_authorized: true

Load `.agents/skills/using-agent-skills/SKILL.md` first. Reverify identity/base/tree/remote/cleanliness,
then execute only R6 and its final combined R1-R6 read-only recovery audit. Do not perform native
actions or begin EVIDENCE:R3-MAC-IMP-01. Sending the terminal receipt to meta must be the final tool
action.

--- FULL RENDERED R6 PROMPT ---

Use $orchestrate-top-level-tasks and every skill required by the increment contract.

ROLE

You are the fresh top-level increment orchestrator for AUX-R3-MAC-EVIDENCE-RECOVERY-R6. You own this increment only.
...
- meta_host_id: local
- increment: AUX-R3-MAC-EVIDENCE-RECOVERY-R6
- packet_id: AUX-R3-MAC-EVIDENCE-RECOVERY-R6
...
/Users/spensermcconnell/.codex/worktrees/1bd8/substrate
...
- expected base commit: a9626bc10a1737416c1d8f7f48630850118f3e6a
- expected base tree: 3f7cdf20125a847a3dfaa472d3797759b5cf6737
