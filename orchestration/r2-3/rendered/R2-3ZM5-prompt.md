...
11. Run direct `cargo test --locked -p shell --lib -- --nocapture` with private mode-0700 external
    roots and require the unchanged accepted `1322 / 1274 / 48 / 0` result, failure-name SHA-256
