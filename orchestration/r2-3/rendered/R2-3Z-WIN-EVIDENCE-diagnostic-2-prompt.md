...
- attempt: `diagnostic-2`
- dispatch_nonce: `3bd5c390682918b36fbf51ef90723e5112a534f166566bff59c159ea5a4208fb`
...
The prior `diagnostic-1` client worktree setup failed before a real task thread existed or identity
was bound. Its nonce and client setup are retired. Do not accept or infer authority from them.

SOURCE BINDING

- remote: `origin`
- worktree starting ref: `origin/feat/internal-host-orchestrator-world-dispatch-bootstrap`
...
Work only in the task-assigned dedicated Codex worktree created from the remote-tracking starting
ref above. Never mutate the saved project checkout. A detached task worktree is normal. After
identity binding, you may fetch the exact target ref and, only if the disposable task worktree is
clean, detach it at the exact source commit. Do not reset, clean, merge, rebase, or modify either
checkout. Before diagnostics, verify the live remote, HEAD, tree, required ancestor, clean status,
and zero product diff.
