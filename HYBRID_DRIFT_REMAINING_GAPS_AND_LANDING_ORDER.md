...
no review result for itself. The
...
8. keep completed, fresh-review-clean promotion series `455d0ed90` + `876ac55de`, entry transition
   ...
   reviewed `CHANGES_REQUIRED` with five docs findings and this bounded fix awaiting fresh review;
...
- **current action:** keep completed, fresh-review-clean promotion series `455d0ed90` + `876ac55de`,
  ...
  `CHANGES_REQUIRED` with five docs findings and this bounded fix awaiting fresh review; keep all
...
- keep R8-SPEC in progress without a phase transition; keep complete-family series `0ed3d8f04` +
  `cfcf65507` at reviewed `CHANGES_REQUIRED`, keep this bounded fix review-pending, and do not start
